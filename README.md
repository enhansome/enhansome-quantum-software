...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,121 | 🐛 537 | 🌐 C++ | 📅 2026-08-27 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,054 | 🐛 111 | 🌐 Python | 📅 2026-08-27 - Framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
...
* [Ocean](https://github.com/dwavesystems/dwave-ocean-sdk) ⭐ 537 | 🐛 26 | 🌐 Python | 📅 2026-08-21 - [D-Wave System](https://www.dwavesys.com/home)'s suite of tools for solving hard problems with quantum computers.
...
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 292 | 🐛 183 | 🌐 Python | 📅 2026-08-26).
* [Perceval](https://github.com/Quandela/Perceval) ⭐ 207 | 🐛 13 | 🌐 Python | 📅 2026-07-31 - [Quandela](https://www.quandela.com)'s software library for programming realistic photonic quantum computers.
...
* [Qristal](https://github.com/qbrilliance/qristal) ⭐ 13 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2025-10-20 - Quantum Brilliance's hybrid quantum-classical C++/Python development platform ([docs](https://qristal.readthedocs.io); [core module](https://github.com/qbrilliance/qristal-core) ⭐ 4 | 🐛 0 | 🌐 C++ | 📅 2025-10-20).
* [hybridlane](https://github.com/pnnl/hybridlane) ⭐ 4 | 🐛 10 | 🌐 Python | 📅 2026-08-26 - Full-stack library for mixed-variable (CV-DV) quantum programming across simulators and hardware within PennyLane.
...
* [Qiskit Aer](https://github.com/Qiskit/qiskit-aer) ⭐ 688 | 🐛 246 | 🌐 C++ | 📅 2026-05-25 - High performance simulator for quantum circuits that includes noise models (supported by IBM).
...
* [Intel Quantum Simulator](https://github.com/intel/intel-qs) ⭐ 263 | 🐛 16 | 🌐 C++ | 📅 2026-08-26 - Distributed qubit register quantum simulator using OpenMP and MPI.
...
* [MQT DDSIM](https://github.com/cda-tum/mqt-ddsim) ⭐ 162 | 🐛 11 | 🌐 C++ | 📅 2026-08-26 - Quantum circuit simulator using decision diagrams as a datastructure. Python interface and Qiskit backend via the [`mqt.ddsim`](https://pypi.org/p/mqt.ddsim) Python package.
...
* [QCSim](https://github.com/aromanro/QCSim) ⭐ 103 | 🐛 6 | 🌐 C++ | 📅 2026-08-23 - Quantum computing simulator with many algorithms as examples and tests ([blog post](https://compphys.go.ro/quantum-computing-simulator/)).
...
* [Quirk](https://github.com/Strilanc/Quirk) ⭐ 1,098 | 🐛 54 | 🌐 JavaScript | 📅 2024-07-16 - Drag-and-drop quantum circuit simulator in your browser.
...
* [Dense-Evolution](https://github.com/tatopenn-cell/Dense-Evolution) ⭐ 14 | 🐛 3 | 🌐 Python | 📅 2026-08-26 - NISQ quantum simulation toolkit — JAX-native.
...
* [Pulser](https://github.com/pasqal-io/Pulser) ⭐ 241 | 🐛 41 | 🌐 Python | 📅 2026-08-21 - Python library for pulse-level/analog control of neutral atom devices.
...
* [qqa](https://github.com/Yuma-Ichikawa/QQA4CO) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - GPU-parallel Quasi-Quantum Annealing toolkit for QUBO and Ising combinatorial optimisation, with PI-GNN / CPRA neural backends and a Simulated Annealing baseline, all under a single PyTorch API.
...
* [ReCirq](https://github.com/quantumlib/ReCirq) ⭐ 309 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modules for running quantum computing applications and experiments through [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,054 | 🐛 111 | 🌐 Python | 📅 2026-08-27.
...
* [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 91 | 🌐 C++ | 📅 2026-08-24 - C++ library for placement, routing, and optimization of quantum circuits (developed by Quantinuum).
* [Catalyst](https://github.com/PennyLaneAI/catalyst) ⭐ 234 | 🐛 313 | 🌐 Python | 📅 2026-08-27 - AOT/JIT compiler for hybrid quantum computing beyond NISQ. Written in MLIR. Python frontend via [PennyLane](https://pennylane.ai).
...
* [MQT QMAP](https://github.com/cda-tum/mqt-qmap) ⭐ 141 | 🐛 24 | 🌐 C++ | 📅 2026-08-26 - Quantum circuit mapping. Clifford synthesis. Compilation for neutral atom architectures. Compatible with Qiskit through the [`mqt.qmap`](https://pypi.org/p/mqt.qmap) Python package.
...
* [MQT SyReC](https://github.com/cda-tum/mqt-syrec) ⭐ 38 | 🐛 20 | 🌐 C++ | 📅 2026-08-26 - HDL-based synthesis of reversible circuits for optimized circuit designs.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,749 | 🐛 1,162 | 🌐 Python | 📅 2026-08-27 - Python library for quantum circuit rewriting and optimization (supported by IBM).
...
* [Mitiq](https://github.com/unitaryfoundation/mitiq) ⭐ 443 | 🐛 97 | 🌐 Python | 📅 2026-08-24 - Cross-platform, quantum error mitigation toolkit and compiler from [Unitary Foundation](https://unitary.foundation/).
...
* [MQT Predictor](https://github.com/cda-tum/mqt-predictor) ⭐ 87 | 🐛 23 | 🌐 Python | 📅 2026-08-26 - RL-based compiler optimization. ML-based device selection. Available via the [`mqt.predictor`](https://pypi.org/p/mqt.predictor) Python package.
...
* [MQT IonShuttler](https://github.com/cda-tum/mqt-ion-shuttler) ⭐ 36 | 🐛 2 | 🌐 Python | 📅 2026-08-26 - Exact and heuristic scheduling to manage ion movement within trapped-ion hardware.
...
* [TKET2](https://github.com/CQCL/tket2) ⭐ 60 | 🐛 184 | 🌐 Rust | 📅 2026-08-24 - Rewrite based toolkit for optimization of quantum programs (version 2 of the [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 91 | 🌐 C++ | 📅 2026-08-24 quantum compiler).
...
* [MQT QECC](https://github.com/cda-tum/mqt-qecc) ⭐ 233 | 🐛 12 | 🌐 Python | 📅 2026-08-26 - Synthesis of fault-tolerant circuits. Decoders. Automatic Application of error correcting codes. Available via the [`mqt.qecc`](https://pypi.org/p/mqt.qecc) Python package.
...
* [Chromobius](https://github.com/quantumlib/chromobius) ⭐ 41 | 🐛 6 | 🌐 Python | 📅 2026-08-01 - Python implementation of a "mobius decoder" for color codes used in quantum error correction.
...
* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,044 | 🐛 116 | 🌐 C | 📅 2026-08-27 - C library for quantum-resistant cryptographic algorithms.
...
* [QCoDeS](https://github.com/QCoDeS/Qcodes) ⭐ 456 | 🐛 267 | 🌐 Python | 📅 2026-08-27 - Python-based data acquisition framework for quantum experiments.
...
* [MQT Qudits](https://github.com/cda-tum/mqt-qudits) ⭐ 39 | 🐛 5 | 🌐 Python | 📅 2026-08-26 - A framework for research and education for mixed-dimensional qudit quantum computing available via the \[`mqt.qudits`] Python package.
...
* [Quantum Nematode](https://github.com/SyntheticBrains/nematode) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2026-08-23 - C. elegans navigation simulation using quantum variational circuits.
...
* [MQT QCEC](https://github.com/cda-tum/mqt-qcec) ⭐ 117 | 🐛 14 | 🌐 C++ | 📅 2026-08-26 - Equivalence checking of quantum circuits. Verifying compilation flows. Available via the [`mqt.qcec`](https://pypi.org/p/mqt.qcec) package and fully compatible with Qiskit.
* [MQT QuSAT](https://github.com/cda-tum/mqt-qusat) ⭐ 28 | 🐛 4 | 🌐 C++ | 📅 2026-08-26 - Encoding and equivalence checking of Clifford circuits using satisfiablity testing (SAT).
...
* [MQT Debugger](https://github.com/cda-tum/mqt-debugger) ⭐ 21 | 🐛 9 | 🌐 C++ | 📅 2026-08-26 - Debugging quantum circuits with IDE integration based on DAP server.
...
* [MQT Bench](https://github.com/cda-tum/mqt-bench) ⭐ 127 | 🐛 19 | 🌐 Python | 📅 2026-08-25 - Quantum circuit benchmark suite providing benchmark algorithms for different compilation levels. Web application hosted at <https://www.cda.cit.tum.de/mqtbench/>. Also available via the [`mqt.bench`](https://pypi.org/p/mqt.bench) Python package.
...
* [MQT Problem Solver](https://github.com/cda-tum/mqt-problemsolver) ⭐ 54 | 🐛 3 | 🌐 Python | 📅 2026-08-26 - Automated Framework for Realizing Quantum Computing Solutions.
...
* [PauLie](https://github.com/QPauLie/PauLie) ⭐ 11 | 🐛 21 | 🌐 Python | 📅 2026-08-21 - Library for studying algebraic properties of quantum systems, in particular the dynamical Lie algebra of Pauli string generated dynamics.
...
* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,749 | 🐛 1,162 | 🌐 Python | 📅 2026-08-27.
...
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,749 | 🐛 1,162 | 🌐 Python | 📅 2026-08-27.
