...
For a curated list of learning resources please check out [desireevl's repo](https://github.com/desireevl/awesome-quantum-computing) ⭐ 3,264 | 🐛 29 | 📅 2024-07-24.
...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,124 | 🐛 551 | 🌐 C++ | 📅 2026-09-02 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,056 | 🐛 109 | 🌐 Python | 📅 2026-09-03 - Framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
* [Forest](https://github.com/rigetticomputing/pyquil) ⭐ 1,498 | 🐛 242 | 🌐 Python | 📅 2026-08-20 - [Rigetti](https://www.rigetti.com/)'s software library for writing, simulating, compiling and executing quantum programs.
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,124 | 🐛 551 | 🌐 C++ | 📅 2026-09-02 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [blueqat](https://github.com/Blueqat/Blueqat) ⭐ 388 | 🐛 1 | 🌐 Python | 📅 2026-09-02 - Quantum computing SDK.
* [Braket](https://github.com/amazon-braket/amazon-braket-sdk-python) ⭐ 374 | 🐛 30 | 🌐 Python | 📅 2026-09-02 - [Amazon's](https://aws.amazon.com/braket/) fully managed quantum computing service for building quantum algorithms.
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 363 | 🐛 106 | 🌐 Python | 📅 2026-09-02 - An open-source framework for quantum simulation, self-hosted quantum hardware control and calibration.
...
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 293 | 🐛 201 | 🌐 Python | 📅 2026-09-02).
* [Perceval](https://github.com/Quandela/Perceval) ⭐ 207 | 🐛 5 | 🌐 Python | 📅 2026-09-02 - [Quandela](https://www.quandela.com)'s software library for programming realistic photonic quantum computers.
...
* [bosonic-qiskit](https://github.com/C2QA/bosonic-qiskit) ⭐ 74 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-07-15 - Simulate hybrid boson-qubit systems within Qiskit, implemented as a part of the Co-design Center for Quantum Advantage (C2QA) of the National Quantum Initiative.
...
* [Qiskit Aer](https://github.com/Qiskit/qiskit-aer) ⭐ 692 | 🐛 249 | 🌐 C++ | 📅 2026-05-25 - High performance simulator for quantum circuits that includes noise models (supported by IBM).
* [qsim](https://github.com/quantumlib/qsim) ⭐ 692 | 🐛 49 | 🌐 C++ | 📅 2026-09-02 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
...
* [MQT DDSIM](https://github.com/cda-tum/mqt-ddsim) ⭐ 162 | 🐛 11 | 🌐 C++ | 📅 2026-09-01 - Quantum circuit simulator using decision diagrams as a datastructure. Python interface and Qiskit backend via the [`mqt.ddsim`](https://pypi.org/p/mqt.ddsim) Python package.
...
* [QCSim](https://github.com/aromanro/QCSim) ⭐ 104 | 🐛 6 | 🌐 C++ | 📅 2026-09-02 - Quantum computing simulator with many algorithms as examples and tests ([blog post](https://compphys.go.ro/quantum-computing-simulator/)).
...
* [QuantumToolbox.jl](https://github.com/qutip/QuantumToolbox.jl) ⭐ 171 | 🐛 33 | 🌐 Julia | 📅 2026-09-02 - High-performance, GPU-ready and autodiff-friendly simulations of open quantum systems.
...
* [PauliStrings.jl](https://github.com/nicolasloizeau/PauliStrings.jl) ⭐ 72 | 🐛 18 | 🌐 Julia | 📅 2026-08-15 - Many-body simulations in the Pauli strings representation.
...
* [Stim](https://github.com/quantumlib/Stim) ⭐ 816 | 🐛 91 | 🌐 C++ | 📅 2026-08-04 - Fast stabilizer circuit simulator.
* [qsim](https://github.com/quantumlib/qsim) ⭐ 692 | 🐛 49 | 🌐 C++ | 📅 2026-09-02 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
* [quimb](https://github.com/jcmgray/quimb) ⭐ 660 | 🐛 69 | 🌐 Python | 📅 2026-09-02 - Easy but fast python library for quantum information and many-body calculations, including with tensor networks.
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 363 | 🐛 106 | 🌐 Python | 📅 2026-09-02 - Framework for quantum simulation with hardware acceleration using just-in-time compilation.
...
* [Tsim](https://github.com/QuEraComputing/tsim) ⭐ 123 | 🐛 10 | 🌐 Python | 📅 2026-09-02 - GPU-accelerated universal quantum circuit sampler via ZX-calculus stabilizer-rank decomposition ([Stim](https://github.com/quantumlib/Stim) ⭐ 816 | 🐛 91 | 🌐 C++ | 📅 2026-08-04-like API, with non-Clifford support).
* [Graphix](https://github.com/TeamGraphix/graphix) ⭐ 115 | 🐛 22 | 🌐 Python | 📅 2026-09-01 - Measurement-Based Quantum Computing (MBQC) compiler, simulator and QPU interface.
...
* [scpn-quantum-control](https://github.com/anulum/scpn-quantum-control) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - Quantum simulation of coupled Kuramoto-XY oscillators on IBM hardware, with Rust-accelerated Hamiltonian construction, synchronisation witnesses, and Lindblad open-system dynamics.
...
* [RustQIP](https://github.com/Renmusxd/RustQIP) ⭐ 313 | 🐛 26 | 🌐 Rust | 📅 2025-12-23 - Rust Quantum Computing library leveraging graph building to build efficient quantum circuit simulations.
...
* [Pulser](https://github.com/pasqal-io/Pulser) ⭐ 242 | 🐛 40 | 🌐 Python | 📅 2026-09-02 - Python library for pulse-level/analog control of neutral atom devices.
...
* [dwave\_networkx](https://github.com/dwavesystems/dwave_networkx) ⭐ 95 | 🐛 39 | 🌐 Python | 📅 2026-06-16 - Exploration and analysis of network graphs.
...
* [qqa](https://github.com/Yuma-Ichikawa/QQA4CO) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - GPU-parallel Quasi-Quantum Annealing toolkit for QUBO and Ising combinatorial optimisation, with PI-GNN / CPRA neural backends and a Simulated Annealing baseline, all under a single PyTorch API.
...
* [OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,733 | 🐛 30 | 🌐 Python | 📅 2026-09-01 - Compiling and analyzing quantum algorithm for quantum chemistry simulations.
...
* [Grove](https://github.com/rigetticomputing/grove) ⚠️ Archived - Quantum algorithms implemented using [Rigetti](https://www.rigetti.com/)'s [pyQuil](https://github.com/rigetticomputing/pyquil) ⭐ 1,498 | 🐛 242 | 🌐 Python | 📅 2026-08-20.
* [ReCirq](https://github.com/quantumlib/ReCirq) ⭐ 309 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modules for running quantum computing applications and experiments through [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,056 | 🐛 109 | 🌐 Python | 📅 2026-09-03.
...
* [pyRiemann-qiskit](https://github.com/pyRiemann/pyRiemann-qiskit) ⭐ 30 | 🐛 18 | 🌐 Python | 📅 2026-09-02 - Library for machine learning and quantum programming based on pyRiemann and Qiskit projects.
...
* [XACC QChem](https://github.com/ORNL-QCI/xacc-qchem-benchmarks) - QPU Benchmarks for Quantum Chemistry via [XACC](https://github.com/ORNL-QCI/xacc) ⭐ 3 | 🐛 7 | 🌐 C++ | 📅 2025-01-17, [Psi4](http://www.psicode.org/) and [OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,733 | 🐛 30 | 🌐 Python | 📅 2026-09-01.
...
* [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 92 | 🌐 C++ | 📅 2026-09-01 - C++ library for placement, routing, and optimization of quantum circuits (developed by Quantinuum).
* [Catalyst](https://github.com/PennyLaneAI/catalyst) ⭐ 235 | 🐛 313 | 🌐 Python | 📅 2026-09-02 - AOT/JIT compiler for hybrid quantum computing beyond NISQ. Written in MLIR. Python frontend via [PennyLane](https://pennylane.ai).
...
* [MQT QMAP](https://github.com/cda-tum/mqt-qmap) ⭐ 141 | 🐛 24 | 🌐 C++ | 📅 2026-09-01 - Quantum circuit mapping. Clifford synthesis. Compilation for neutral atom architectures. Compatible with Qiskit through the [`mqt.qmap`](https://pypi.org/p/mqt.qmap) Python package.
...
* [MQT SyReC](https://github.com/cda-tum/mqt-syrec) ⭐ 38 | 🐛 21 | 🌐 C++ | 📅 2026-09-01 - HDL-based synthesis of reversible circuits for optimized circuit designs.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,768 | 🐛 1,188 | 🌐 Python | 📅 2026-09-02 - Python library for quantum circuit rewriting and optimization (supported by IBM).
* [PyZX](https://github.com/Quantomatic/pyzx) ⭐ 540 | 🐛 25 | 🌐 OpenQASM | 📅 2026-09-01 - Python library for quantum circuit rewriting and optimisation using the ZX-calculus.
* [Mitiq](https://github.com/unitaryfoundation/mitiq) ⭐ 444 | 🐛 114 | 🌐 Python | 📅 2026-09-02 - Cross-platform, quantum error mitigation toolkit and compiler from [Unitary Foundation](https://unitary.foundation/).
...
* [MQT Predictor](https://github.com/cda-tum/mqt-predictor) ⭐ 87 | 🐛 28 | 🌐 Python | 📅 2026-08-31 - RL-based compiler optimization. ML-based device selection. Available via the [`mqt.predictor`](https://pypi.org/p/mqt.predictor) Python package.
...
* [MQT IonShuttler](https://github.com/cda-tum/mqt-ion-shuttler) ⭐ 36 | 🐛 2 | 🌐 Python | 📅 2026-08-31 - Exact and heuristic scheduling to manage ion movement within trapped-ion hardware.
...
* [CleitonForge](https://github.com/cleitonaugusto/CleitonForge) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - Differential fuzzer for quantum compilers and simulators (Rust + Python), with a shrinker and an exact-operator oracle.
...
* [TKET2](https://github.com/CQCL/tket2) ⭐ 60 | 🐛 183 | 🌐 Rust | 📅 2026-09-02 - Rewrite based toolkit for optimization of quantum programs (version 2 of the [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 92 | 🌐 C++ | 📅 2026-09-01 quantum compiler).
...
* [OpenQASM](https://github.com/QISKit/openqasm) ⭐ 1,503 | 🐛 108 | 🌐 Python | 📅 2026-09-02 - Open-source quantum assembly language.
* [Quil](https://arxiv.org/abs/1608.03355) - Open hybrid quantum/classical instruction set currently used by Rigetti. [Parser](https://github.com/rigetticomputing/pyquil/tree/master/pyquil/_parser) ⭐ 1,498 | 🐛 242 | 🌐 Python | 📅 2026-08-20
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 363 | 🐛 106 | 🌐 Python | 📅 2026-09-02 - Qibo provides a platform agnostic quantum hardware control module with drivers for multiple instruments.
...
* [Tesseract Decoder](https://github.com/quantumlib/tesseract-decoder) ⭐ 116 | 🐛 33 | 🌐 C++ | 📅 2026-09-02 - Most Likely Error decoder designed for Low Density Parity Check (LDPC) quantum error-correcting codes.

**Julia**

* [CodingTheory](https://github.com/esabo/CodingTheory) ⭐ 40 | 🐛 12 | 🌐 Julia | 📅 2026-09-03 - Julia package for constructing and analyzing classical and quantum error-correcting codes.
...
* [MQT QECC](https://github.com/cda-tum/mqt-qecc) ⭐ 236 | 🐛 12 | 🌐 Python | 📅 2026-09-02 - Synthesis of fault-tolerant circuits. Decoders. Automatic Application of error correcting codes. Available via the [`mqt.qecc`](https://pypi.org/p/mqt.qecc) Python package.
...
* [Qsurface](https://github.com/watermarkhu/qsurface) ⭐ 81 | 🐛 20 | 🌐 Python | 📅 2026-09-01 - Python package for simulation and visualization of quantum error-correction on surface codes.
...
* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,051 | 🐛 117 | 🌐 C | 📅 2026-09-02 - C library for quantum-resistant cryptographic algorithms.
...
* [QRL](https://github.com/theQRL/QRL/) ⭐ 466 | 🐛 51 | 🌐 Python | 📅 2026-08-29 - [Quantum Resistant Ledger](https://theqrl.org/) utilizing hash-based one-time merkle tree signature scheme instead of ECDSA.
...
* [QCoDeS](https://github.com/QCoDeS/Qcodes) ⭐ 458 | 🐛 268 | 🌐 Python | 📅 2026-09-02 - Python-based data acquisition framework for quantum experiments.
...
* [scqubits](https://github.com/scqubits/scqubits) ⭐ 284 | 🐛 21 | 🌐 Python | 📅 2026-09-02 - Simulating superconducting qubits, obtaining energy spectra, plotting energy levels and more.
...
* [MQT Qudits](https://github.com/cda-tum/mqt-qudits) ⭐ 39 | 🐛 7 | 🌐 Python | 📅 2026-09-02 - A framework for research and education for mixed-dimensional qudit quantum computing available via the \[`mqt.qudits`] Python package.
...
* [Quantum Nematode](https://github.com/SyntheticBrains/nematode) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2026-08-27 - C. elegans navigation simulation using quantum variational circuits.
...
* [MQT QCEC](https://github.com/cda-tum/mqt-qcec) ⭐ 117 | 🐛 15 | 🌐 C++ | 📅 2026-09-01 - Equivalence checking of quantum circuits. Verifying compilation flows. Available via the [`mqt.qcec`](https://pypi.org/p/mqt.qcec) package and fully compatible with Qiskit.
* [MQT QuSAT](https://github.com/cda-tum/mqt-qusat) ⭐ 28 | 🐛 4 | 🌐 C++ | 📅 2026-09-01 - Encoding and equivalence checking of Clifford circuits using satisfiablity testing (SAT).
* [MQT DDVis](https://github.com/cda-tum/mqt-ddvis) ⭐ 27 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-31 - Installation-free web-tool that visualizes quantum decision diagrams for classical simulation and verification. Hosted at <https://www.cda.cit.tum.de/app/ddvis/>.
* [MQT Debugger](https://github.com/cda-tum/mqt-debugger) ⭐ 21 | 🐛 10 | 🌐 C++ | 📅 2026-09-01 - Debugging quantum circuits with IDE integration based on DAP server.
...
* [toqito](https://github.com/vprusso/toqito) ⭐ 290 | 🐛 3 | 🌐 Python | 📅 2026-09-03 - Framework to study problems pertaining to entanglement theory, nonlocal games, and other aspects of quantum information.
* [MQT Bench](https://github.com/cda-tum/mqt-bench) ⭐ 127 | 🐛 19 | 🌐 Python | 📅 2026-08-31 - Quantum circuit benchmark suite providing benchmark algorithms for different compilation levels. Web application hosted at <https://www.cda.cit.tum.de/mqtbench/>. Also available via the [`mqt.bench`](https://pypi.org/p/mqt.bench) Python package.
...
* [MQT Problem Solver](https://github.com/cda-tum/mqt-problemsolver) ⭐ 54 | 🐛 3 | 🌐 Python | 📅 2026-08-31 - Automated Framework for Realizing Quantum Computing Solutions.
...
* [PauLie](https://github.com/QPauLie/PauLie) ⭐ 11 | 🐛 20 | 🌐 Python | 📅 2026-09-01 - Library for studying algebraic properties of quantum systems, in particular the dynamical Lie algebra of Pauli string generated dynamics.
...
* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,768 | 🐛 1,188 | 🌐 Python | 📅 2026-09-02.
...
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,768 | 🐛 1,188 | 🌐 Python | 📅 2026-09-02.
