...
For a curated list of learning resources please check out [desireevl's repo](https://github.com/desireevl/awesome-quantum-computing) ⭐ 3,268 | 🐛 30 | 📅 2024-07-24.
...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,127 | 🐛 546 | 🌐 C++ | 📅 2026-09-10 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [staq](https://github.com/softwareqinc/staq) ⭐ 185 | 🐛 7 | 🌐 OpenQASM | 📅 2026-02-22 - Full stack quantum processing toolkit ([arXiv paper](https://arxiv.org/abs/1912.06070)).
...
* [XACC](https://github.com/ORNL-QCI/xacc) ⭐ 3 | 🐛 7 | 🌐 C++ | 📅 2025-01-17 - Extreme-scale programming model for quantum acceleration within high-performance computing ([arXiv paper](https://arxiv.org/abs/1710.01794)).
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,058 | 🐛 111 | 🌐 Python | 📅 2026-09-10 - Framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
* [Forest](https://github.com/rigetticomputing/pyquil) ⭐ 1,497 | 🐛 243 | 🌐 Python | 📅 2026-09-08 - [Rigetti](https://www.rigetti.com/)'s software library for writing, simulating, compiling and executing quantum programs.
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,127 | 🐛 546 | 🌐 C++ | 📅 2026-09-10 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
* [ProjectQ](https://github.com/ProjectQ-Framework/ProjectQ) ⭐ 978 | 🐛 41 | 🌐 Python | 📅 2026-08-31 - Hardware-agnostic framework with compiler and simulator with emulation capabilities.
...
* [Ocean](https://github.com/dwavesystems/dwave-ocean-sdk) ⭐ 539 | 🐛 26 | 🌐 Python | 📅 2026-08-31 - [D-Wave System](https://www.dwavesys.com/home)'s suite of tools for solving hard problems with quantum computers.
* [Tequila](https://github.com/aspuru-guzik-group/tequila) ⭐ 439 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - Extensible Quantum Information and Learning Architecture developed by Alan Aspuru-Guzik's group (UofT).
* [blueqat](https://github.com/Blueqat/Blueqat) ⭐ 388 | 🐛 2 | 🌐 Python | 📅 2026-09-02 - Quantum computing SDK.
* [Braket](https://github.com/amazon-braket/amazon-braket-sdk-python) ⭐ 373 | 🐛 31 | 🌐 Python | 📅 2026-09-03 - [Amazon's](https://aws.amazon.com/braket/) fully managed quantum computing service for building quantum algorithms.
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 365 | 🐛 105 | 🌐 Python | 📅 2026-09-09 - An open-source framework for quantum simulation, self-hosted quantum hardware control and calibration.
* [TensorCircuit](https://github.com/tencent-quantum-lab/tensorcircuit) ⭐ 358 | 🐛 24 | 🌐 Python | 📅 2025-10-22 - Tensor network based quantum software framework for the NISQ era.
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 294 | 🐛 205 | 🌐 Python | 📅 2026-09-09).
* [Perceval](https://github.com/Quandela/Perceval) ⭐ 208 | 🐛 6 | 🌐 Python | 📅 2026-09-02 - [Quandela](https://www.quandela.com)'s software library for programming realistic photonic quantum computers.
...
* [Qristal](https://github.com/qbrilliance/qristal) ⭐ 13 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2025-10-20 - Quantum Brilliance's hybrid quantum-classical C++/Python development platform ([docs](https://qristal.readthedocs.io); [core module](https://github.com/qbrilliance/qristal-core) ⭐ 4 | 🐛 0 | 🌐 C++ | 📅 2025-10-20).
* [hybridlane](https://github.com/pnnl/hybridlane) ⭐ 4 | 🐛 11 | 🌐 Python | 📅 2026-09-02 - Full-stack library for mixed-variable (CV-DV) quantum programming across simulators and hardware within PennyLane.
...
* [Quplexity](https://github.com/MrGilli/Quplexity) ⭐ 37 | 🐛 1 | 🌐 Assembly | 📅 2025-09-23 - Modular toolkit for QC simulators. Quplexity offers essential mathematical functions and logic relative to quantum computer simulation. Quplexity is written in ARM(64) and x86 Assembly, which results in improved performance and "weight" benefits.

**C**

* [QuEST](https://github.com/aniabrown/QuEST) ⭐ 486 | 🐛 56 | 🌐 C++ | 📅 2026-08-21 -  Quantum Exact Simulation Toolkit is a high performance multicore simulator of universal quantum circuits.
...
* [qsim](https://github.com/quantumlib/qsim) ⭐ 696 | 🐛 48 | 🌐 C++ | 📅 2026-09-04 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
* [Qiskit Aer](https://github.com/Qiskit/qiskit-aer) ⭐ 693 | 🐛 251 | 🌐 C++ | 📅 2026-05-25 - High performance simulator for quantum circuits that includes noise models (supported by IBM).
...
* [Intel Quantum Simulator](https://github.com/intel/intel-qs) ⭐ 263 | 🐛 19 | 🌐 C++ | 📅 2026-09-02 - Distributed qubit register quantum simulator using OpenMP and MPI.
* [Qrack](https://github.com/vm6502q/qrack) ⭐ 231 | 🐛 11 | 🌐 C++ | 📅 2026-09-07 - Comprehensive qubit and gate implementation for developing universal virtual quantum processors.
* [MQT DDSIM](https://github.com/cda-tum/mqt-ddsim) ⭐ 162 | 🐛 9 | 🌐 C++ | 📅 2026-09-08 - Quantum circuit simulator using decision diagrams as a datastructure. Python interface and Qiskit backend via the [`mqt.ddsim`](https://pypi.org/p/mqt.ddsim) Python package.
* [PennyLane Lightning](https://github.com/PennyLaneAI/pennylane-lightning) ⭐ 146 | 🐛 42 | 🌐 C++ | 📅 2026-09-09 - Fast state-vector simulator written in C++. GPU support. Python interface via [PennyLane](https://pennylane.ai).
...
* [QCSim](https://github.com/aromanro/QCSim) ⭐ 104 | 🐛 4 | 🌐 C++ | 📅 2026-09-04 - Quantum computing simulator with many algorithms as examples and tests ([blog post](https://compphys.go.ro/quantum-computing-simulator/)).
...
* [Q](https://github.com/itsubaki/q) ⭐ 283 | 🐛 1 | 🌐 Go | 📅 2026-09-08 - Quantum Computation Simulator written purely in GoLang.
...
* [Quirk](https://github.com/Strilanc/Quirk) ⭐ 1,100 | 🐛 54 | 🌐 JavaScript | 📅 2024-07-16 - Drag-and-drop quantum circuit simulator in your browser.
...
* [Yao.jl](https://github.com/QuantumBFS/Yao.jl) ⭐ 1,041 | 🐛 29 | 🌐 Julia | 📅 2026-09-09 - Extensible, Efficient Quantum Algorithm Design for Humans.
* [QuantumToolbox.jl](https://github.com/qutip/QuantumToolbox.jl) ⭐ 171 | 🐛 31 | 🌐 Julia | 📅 2026-09-08 - High-performance, GPU-ready and autodiff-friendly simulations of open quantum systems.
...
* [PauliStrings.jl](https://github.com/nicolasloizeau/PauliStrings.jl) ⭐ 73 | 🐛 18 | 🌐 Julia | 📅 2026-08-15 - Many-body simulations in the Pauli strings representation.
...
* [Stim](https://github.com/quantumlib/Stim) ⭐ 817 | 🐛 92 | 🌐 C++ | 📅 2026-08-04 - Fast stabilizer circuit simulator.
* [qsim](https://github.com/quantumlib/qsim) ⭐ 696 | 🐛 48 | 🌐 C++ | 📅 2026-09-04 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
* [quimb](https://github.com/jcmgray/quimb) ⭐ 665 | 🐛 68 | 🌐 Python | 📅 2026-09-10 - Easy but fast python library for quantum information and many-body calculations, including with tensor networks.
* [Quintuple](https://github.com/corbett/QuantumComputing) ⭐ 627 | 🐛 3 | 🌐 Python | 📅 2022-12-29 - Simulating the 5-qubit processor of the [IBM Quantum Experience](https://quantumexperience.ng.bluemix.net/qx/experience).
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 365 | 🐛 105 | 🌐 Python | 📅 2026-09-09 - Framework for quantum simulation with hardware acceleration using just-in-time compilation.
* [QuNetSim](https://github.com/tqsd/QuNetSim) ⭐ 143 | 🐛 23 | 🌐 Python | 📅 2024-04-02 - Quantum network simulation framework.
* [SimulaQron](https://github.com/StephanieWehner/SimulaQron) ⭐ 134 | 🐛 15 | 🌐 Python | 📅 2026-05-15 - Application level simulator of a quantum network.
* [Tsim](https://github.com/QuEraComputing/tsim) ⭐ 125 | 🐛 11 | 🌐 Python | 📅 2026-09-04 - GPU-accelerated universal quantum circuit sampler via ZX-calculus stabilizer-rank decomposition ([Stim](https://github.com/quantumlib/Stim) ⭐ 817 | 🐛 92 | 🌐 C++ | 📅 2026-08-04-like API, with non-Clifford support).
* [Graphix](https://github.com/TeamGraphix/graphix) ⭐ 115 | 🐛 21 | 🌐 Python | 📅 2026-09-09 - Measurement-Based Quantum Computing (MBQC) compiler, simulator and QPU interface.
...
* [Piquasso](https://github.com/Budapest-Quantum-Computing-Group/piquasso) ⭐ 61 | 🐛 15 | 🌐 Python | 📅 2026-09-02 - A photonic quantum computing simulator library written in Python/C++.
...
* [Dense-Evolution](https://github.com/tatopenn-cell/Dense-Evolution) ⭐ 16 | 🐛 6 | 🌐 Python | 📅 2026-09-10 - NISQ quantum simulation toolkit — JAX-native.
...
* [scpn-quantum-control](https://github.com/anulum/scpn-quantum-control) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - Quantum simulation of coupled Kuramoto-XY oscillators on IBM hardware, with Rust-accelerated Hamiltonian construction, synchronisation witnesses, and Lindblad open-system dynamics.
...
* [RustQIP](https://github.com/Renmusxd/RustQIP) ⭐ 314 | 🐛 26 | 🌐 Rust | 📅 2025-12-23 - Rust Quantum Computing library leveraging graph building to build efficient quantum circuit simulations.
...
* [Pulser](https://github.com/pasqal-io/Pulser) ⭐ 243 | 🐛 41 | 🌐 Python | 📅 2026-09-09 - Python library for pulse-level/analog control of neutral atom devices.
...
* [dimod](https://github.com/dwavesystems/dimod) ⭐ 142 | 🐛 159 | 🌐 Python | 📅 2026-09-09 - Shared API for Ising and QUBO problems.
...
* [dwave\_networkx](https://github.com/dwavesystems/dwave_networkx) ⭐ 95 | 🐛 38 | 🌐 Python | 📅 2026-09-04 - Exploration and analysis of network graphs.
...
* [dwave-cloud-client](https://github.com/dwavesystems/dwave-cloud-client) ⭐ 63 | 🐛 79 | 🌐 Python | 📅 2026-09-02 - Min. implementation of the REST interface to communicate with D-Wave's Solver API.
* [qubo-nn](https://github.com/instance01/qubo-nn/) ⭐ 56 | 🐛 0 | 🌐 Python | 📅 2021-09-29 - Classifying, auto-encoding and reverse-engineering QUBO matrices. Also includes 20 problem formulations.
* [minorminer](https://github.com/dwavesystems/minorminer) ⭐ 54 | 🐛 32 | 🌐 Python | 📅 2026-08-19 - Heuristic tool for minor graph embedding.
...
* [qqa](https://github.com/Yuma-Ichikawa/QQA4CO) ⭐ 23 | 🐛 1 | 🌐 Python | 📅 2026-09-06 - GPU-parallel Quasi-Quantum Annealing toolkit for QUBO and Ising combinatorial optimisation, with PI-GNN / CPRA neural backends and a Simulated Annealing baseline, all under a single PyTorch API.
...
* [micro\_client\_sapi\_dimod](https://github.com/dwavesystems/dwave_micro_client_dimod) ⚠️ Archived - [Dimod](https://github.com/dwavesystems/dimod) ⭐ 142 | 🐛 159 | 🌐 Python | 📅 2026-09-09 wrapper for the D-Wave Micro Client.
...
* [XACC VQE](https://github.com/ornl-qci/xacc-vqe) ⭐ 15 | 🐛 13 | 🌐 C++ | 📅 2019-07-09 - Variational quantum eigensolver built on [XACC](https://github.com/ORNL-QCI/xacc) ⭐ 3 | 🐛 7 | 🌐 C++ | 📅 2025-01-17 for distributed, and shared memory systems.
...
* [OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,733 | 🐛 31 | 🌐 Python | 📅 2026-09-07 - Compiling and analyzing quantum algorithm for quantum chemistry simulations.
* [QPanda](https://github.com/OriginQ/QPanda-2) ⭐ 1,209 | 🐛 18 | 🌐 C++ | 📅 2024-11-13 - QPanda is a quantum computing framework that can be used to build, run, and optimize quantum algorithms.
...
* [Qiskit Nature](https://github.com/Qiskit/qiskit-nature) ⭐ 399 | 🐛 58 | 🌐 Python | 📅 2026-08-13 - Quantum Chemistry including ground state, excited states and dipole moment calculations.
* [Grove](https://github.com/rigetticomputing/grove) ⚠️ Archived - Quantum algorithms implemented using [Rigetti](https://www.rigetti.com/)'s [pyQuil](https://github.com/rigetticomputing/pyquil) ⭐ 1,497 | 🐛 243 | 🌐 Python | 📅 2026-09-08.
* [ReCirq](https://github.com/quantumlib/ReCirq) ⭐ 309 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modules for running quantum computing applications and experiments through [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,058 | 🐛 111 | 🌐 Python | 📅 2026-09-10.
* [OpenQAOA](https://github.com/entropicalabs/openqaoa) ⭐ 143 | 🐛 25 | 🌐 Python | 📅 2024-08-29 - Multi-backend SDK to create, customise and execute QAOA on NISQ devices and simulators.
...
* [FermiLib](https://github.com/ProjectQ-Framework/FermiLib) ⭐ 90 | 🐛 4 | 🌐 Python | 📅 2018-05-04 - Software for analyzing fermionic quantum simulation algorithms with [ProjectQ](https://github.com/ProjectQ-Framework/ProjectQ) ⭐ 978 | 🐛 41 | 🌐 Python | 📅 2026-08-31.
...
* [pyRiemann-qiskit](https://github.com/pyRiemann/pyRiemann-qiskit) ⭐ 30 | 🐛 14 | 🌐 Python | 📅 2026-09-09 - Library for machine learning and quantum programming based on pyRiemann and Qiskit projects.
...
* [XACC QChem](https://github.com/ORNL-QCI/xacc-qchem-benchmarks) - QPU Benchmarks for Quantum Chemistry via [XACC](https://github.com/ORNL-QCI/xacc) ⭐ 3 | 🐛 7 | 🌐 C++ | 📅 2025-01-17, [Psi4](http://www.psicode.org/) and [OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,733 | 🐛 31 | 🌐 Python | 📅 2026-09-07.
...
* [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 91 | 🌐 C++ | 📅 2026-09-09 - C++ library for placement, routing, and optimization of quantum circuits (developed by Quantinuum).
* [Catalyst](https://github.com/PennyLaneAI/catalyst) ⭐ 234 | 🐛 325 | 🌐 Python | 📅 2026-09-09 - AOT/JIT compiler for hybrid quantum computing beyond NISQ. Written in MLIR. Python frontend via [PennyLane](https://pennylane.ai).
...
* [MQT QMAP](https://github.com/cda-tum/mqt-qmap) ⭐ 142 | 🐛 20 | 🌐 C++ | 📅 2026-09-09 - Quantum circuit mapping. Clifford synthesis. Compilation for neutral atom architectures. Compatible with Qiskit through the [`mqt.qmap`](https://pypi.org/p/mqt.qmap) Python package.
...
* [MQT SyReC](https://github.com/cda-tum/mqt-syrec) ⭐ 39 | 🐛 19 | 🌐 C++ | 📅 2026-09-07 - HDL-based synthesis of reversible circuits for optimized circuit designs.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,788 | 🐛 1,171 | 🌐 Python | 📅 2026-09-09 - Python library for quantum circuit rewriting and optimization (supported by IBM).
* [PyZX](https://github.com/Quantomatic/pyzx) ⭐ 542 | 🐛 25 | 🌐 OpenQASM | 📅 2026-09-09 - Python library for quantum circuit rewriting and optimisation using the ZX-calculus.
* [Mitiq](https://github.com/unitaryfoundation/mitiq) ⭐ 445 | 🐛 102 | 🌐 Python | 📅 2026-09-09 - Cross-platform, quantum error mitigation toolkit and compiler from [Unitary Foundation](https://unitary.foundation/).
...
* [MQT Predictor](https://github.com/cda-tum/mqt-predictor) ⭐ 87 | 🐛 28 | 🌐 Python | 📅 2026-09-07 - RL-based compiler optimization. ML-based device selection. Available via the [`mqt.predictor`](https://pypi.org/p/mqt.predictor) Python package.
* [UCC](https://github.com/unitaryfoundation/ucc/) ⭐ 79 | 🐛 53 | 🌐 Python | 📅 2026-08-31 - Unitary Compiler Collection: frontend-agnostic open-source quantum compiler developed by Unitary Foundation.
...
* [MQT IonShuttler](https://github.com/cda-tum/mqt-ion-shuttler) ⭐ 36 | 🐛 2 | 🌐 Python | 📅 2026-09-08 - Exact and heuristic scheduling to manage ion movement within trapped-ion hardware.
...
* [CleitonForge](https://github.com/cleitonaugusto/CleitonForge) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - Differential fuzzer for quantum compilers and simulators (Rust + Python), with a shrinker and an exact-operator oracle.
* [Qiskit ZX transpiler](https://github.com/dlyongemallo/qiskit-zx-transpiler) ⭐ 6 | 🐛 2 | 🌐 Python | 📅 2026-04-25 - Transpiler pass for Qiskit which uses ZX-calculus for circuit optimization.
...
* [TKET2](https://github.com/CQCL/tket2) ⭐ 60 | 🐛 174 | 🌐 Rust | 📅 2026-09-09 - Rewrite based toolkit for optimization of quantum programs (version 2 of the [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 91 | 🌐 C++ | 📅 2026-09-09 quantum compiler).
...
* [OpenQASM](https://github.com/QISKit/openqasm) ⭐ 1,504 | 🐛 109 | 🌐 Python | 📅 2026-09-02 - Open-source quantum assembly language.
* [Quil](https://arxiv.org/abs/1608.03355) - Open hybrid quantum/classical instruction set currently used by Rigetti. [Parser](https://github.com/rigetticomputing/pyquil/tree/master/pyquil/_parser) ⭐ 1,497 | 🐛 243 | 🌐 Python | 📅 2026-09-08
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 365 | 🐛 105 | 🌐 Python | 📅 2026-09-09 - Qibo provides a platform agnostic quantum hardware control module with drivers for multiple instruments.
...
* [Tesseract Decoder](https://github.com/quantumlib/tesseract-decoder) ⭐ 118 | 🐛 30 | 🌐 C++ | 📅 2026-09-09 - Most Likely Error decoder designed for Low Density Parity Check (LDPC) quantum error-correcting codes.

**Julia**

* [CodingTheory](https://github.com/esabo/CodingTheory) ⭐ 41 | 🐛 12 | 🌐 Julia | 📅 2026-09-09 - Julia package for constructing and analyzing classical and quantum error-correcting codes.

**Python**

* [PyMatching](https://github.com/oscarhiggott/PyMatching) ⭐ 359 | 🐛 27 | 🌐 C++ | 📅 2026-05-22 - Python package for decoding quantum error correcting codes with minimum-weight perfect matching.
* [MQT QECC](https://github.com/cda-tum/mqt-qecc) ⭐ 237 | 🐛 12 | 🌐 Python | 📅 2026-09-08 - Synthesis of fault-tolerant circuits. Decoders. Automatic Application of error correcting codes. Available via the [`mqt.qecc`](https://pypi.org/p/mqt.qecc) Python package.
* [Qiskit Experiments](https://github.com/Qiskit-Extensions/qiskit-experiments) ⭐ 196 | 🐛 138 | 🌐 Python | 📅 2026-09-10 - Python package for quantum error correction experiments (supported by IBM).
* [Tesseract Decoder](https://github.com/quantumlib/tesseract-decoder) ⭐ 118 | 🐛 30 | 🌐 C++ | 📅 2026-09-09 - Most Likely Error decoder designed for Low Density Parity Check (LDPC) quantum error-correcting codes.
...
* [Qsurface](https://github.com/watermarkhu/qsurface) ⭐ 81 | 🐛 20 | 🌐 Python | 📅 2026-09-09 - Python package for simulation and visualization of quantum error-correction on surface codes.
...
* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,060 | 🐛 108 | 🌐 C | 📅 2026-09-10 - C library for quantum-resistant cryptographic algorithms.
...
* [QRL](https://github.com/theQRL/QRL/) ⭐ 467 | 🐛 57 | 🌐 Python | 📅 2026-08-29 - [Quantum Resistant Ledger](https://theqrl.org/) utilizing hash-based one-time merkle tree signature scheme instead of ECDSA.
...
* [QCoDeS](https://github.com/QCoDeS/Qcodes) ⭐ 458 | 🐛 281 | 🌐 Python | 📅 2026-09-09 - Python-based data acquisition framework for quantum experiments.
...
* [scqubits](https://github.com/scqubits/scqubits) ⭐ 284 | 🐛 21 | 🌐 Python | 📅 2026-09-07 - Simulating superconducting qubits, obtaining energy spectra, plotting energy levels and more.
* [PyRPL](https://github.com/lneuhaus/pyrpl) ⭐ 210 | 🐛 157 | 🌐 HTML | 📅 2026-09-09 - Turn your RedPitaya into a powerful DSP device, suitable as a digital lockbox and measurement device in quantum optics.
* [pyEPR](https://github.com/zlatko-minev/pyEPR) ⭐ 209 | 🐛 12 | 🌐 Python | 📅 2026-07-17 - Automated Python module for the design and quantization of Josephson quantum circuits.
...
* [MQT Qudits](https://github.com/cda-tum/mqt-qudits) ⭐ 39 | 🐛 7 | 🌐 Python | 📅 2026-09-09 - A framework for research and education for mixed-dimensional qudit quantum computing available via the \[`mqt.qudits`] Python package.
...
* [Quandoom](https://github.com/Lumorti/Quandoom) ⭐ 950 | 🐛 0 | 🌐 C++ | 📅 2024-12-20 - Port of DOOM for a quantum computer.
...
* [Quantum Nematode](https://github.com/SyntheticBrains/nematode) ⭐ 4 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - C. elegans navigation simulation using quantum variational circuits.
...
* [MQT QCEC](https://github.com/cda-tum/mqt-qcec) ⭐ 117 | 🐛 10 | 🌐 C++ | 📅 2026-09-08 - Equivalence checking of quantum circuits. Verifying compilation flows. Available via the [`mqt.qcec`](https://pypi.org/p/mqt.qcec) package and fully compatible with Qiskit.
* [MQT QuSAT](https://github.com/cda-tum/mqt-qusat) ⭐ 28 | 🐛 2 | 🌐 C++ | 📅 2026-09-07 - Encoding and equivalence checking of Clifford circuits using satisfiablity testing (SAT).
* [MQT DDVis](https://github.com/cda-tum/mqt-ddvis) ⭐ 27 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-06 - Installation-free web-tool that visualizes quantum decision diagrams for classical simulation and verification. Hosted at <https://www.cda.cit.tum.de/app/ddvis/>.
* [MQT Debugger](https://github.com/cda-tum/mqt-debugger) ⭐ 21 | 🐛 15 | 🌐 C++ | 📅 2026-09-07 - Debugging quantum circuits with IDE integration based on DAP server.
...
* [Covalent](https://github.com/AgnostiqHQ/covalent) ⭐ 869 | 🐛 103 | 🌐 Python | 📅 2026-08-31 - Tool for running high performance/quantum workflows on advanced computing hardwares.
* [toqito](https://github.com/vprusso/toqito) ⭐ 290 | 🐛 5 | 🌐 Python | 📅 2026-09-08 - Framework to study problems pertaining to entanglement theory, nonlocal games, and other aspects of quantum information.
* [MQT Bench](https://github.com/cda-tum/mqt-bench) ⭐ 127 | 🐛 19 | 🌐 Python | 📅 2026-09-07 - Quantum circuit benchmark suite providing benchmark algorithms for different compilation levels. Web application hosted at <https://www.cda.cit.tum.de/mqtbench/>. Also available via the [`mqt.bench`](https://pypi.org/p/mqt.bench) Python package.
* [ZXLive](https://github.com/Quantomatic/zxlive) ⭐ 104 | 🐛 67 | 🌐 Python | 📅 2026-08-21 - GUI editor for ZX diagrams.
...
* [MQT Problem Solver](https://github.com/cda-tum/mqt-problemsolver) ⭐ 54 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Automated Framework for Realizing Quantum Computing Solutions.
...
* [PauLie](https://github.com/QPauLie/PauLie) ⭐ 11 | 🐛 21 | 🌐 Python | 📅 2026-09-01 - Library for studying algebraic properties of quantum systems, in particular the dynamical Lie algebra of Pauli string generated dynamics.
...
* [QDataSet](https://github.com/eperrier/QDataSet) ⭐ 137 | 🐛 1 | 🌐 Python | 📅 2021-08-17 - Quantum datasets for the training and development of QML algorithms.
* [QuPrep](https://github.com/quprep/quprep) ⭐ 3 | 🐛 5 | 🌐 Python | 📅 2026-09-07 - Classical-to-quantum data encoding and preprocessing library for quantum machine learning.

## Abandoned projects

*2+ years of inactivity. Feel free to reanimate, document and contribute to some of this work!*

* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,788 | 🐛 1,171 | 🌐 Python | 📅 2026-09-09.
* [QuSim](https://github.com/adamisntdead/QuSimPy) ⭐ 728 | 🐛 2 | 🌐 Python | 📅 2021-06-04 - Ideal noise-free multi-qubit simulator written in 150 lines of code.
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,788 | 🐛 1,171 | 🌐 Python | 📅 2026-09-09.
...
* [8Q](https://github.com/Spooky-Manufacturing/8Q) ⭐ 100 | 🐛 4 | 🌐 Python | 📅 2022-05-02 - 8 Qbit, Photonic Quantum Computer.
...
* [BLACK-STONE](https://github.com/thephoeron/black-stone) ⭐ 71 | 🐛 4 | 🌐 Common Lisp | 📅 2017-02-17 - Specification and implementation of quantum common lisp, for gate-model quantum computers.
...
* [QSEL](https://github.com/dabacon/qsel) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2023-02-26 -  Quantum programming language putting entanglement and superposition front and center.
...
* [sapi\_dimod](https://github.com/dwavesystems/dwave_sapi_dimod) ⚠️ Archived - [Dimod](https://github.com/dwavesystems/dimod) ⭐ 142 | 🐛 159 | 🌐 Python | 📅 2026-09-09 wrapper for D-Wave's Solver API (SAPI).
