...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,144 | 🐛 543 | 🌐 C++ | 📅 2026-09-24 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,070 | 🐛 125 | 🌐 Python | 📅 2026-09-24 - Framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
...
* [Braket](https://github.com/amazon-braket/amazon-braket-sdk-python) ⭐ 373 | 🐛 31 | 🌐 Python | 📅 2026-09-23 - [Amazon's](https://aws.amazon.com/braket/) fully managed quantum computing service for building quantum algorithms.
...
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 297 | 🐛 212 | 🌐 Python | 📅 2026-09-24).
...
* [Qristal](https://github.com/qbrilliance/qristal) ⭐ 13 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2025-10-20 - Quantum Brilliance's hybrid quantum-classical C++/Python development platform ([docs](https://qristal.readthedocs.io); [core module](https://github.com/qbrilliance/qristal-core) ⭐ 4 | 🐛 0 | 🌐 C++ | 📅 2025-10-20).
* [qsim-sdk](https://github.com/official-dvl/zksf) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2026-09-24 - Client for the [ZKSF](https://zksf.org) cloud simulation service, running circuits on CPU, GPU and quantum hardware, with a measured accuracy statement returned alongside every approximate result ([docs](https://zksf.org/docs/)).
...
* [QuEST](https://github.com/aniabrown/QuEST) ⭐ 488 | 🐛 52 | 🌐 C++ | 📅 2026-09-24 -  Quantum Exact Simulation Toolkit is a high performance multicore simulator of universal quantum circuits.
...
* [Qiskit Aer](https://github.com/Qiskit/qiskit-aer) ⭐ 698 | 🐛 253 | 🌐 C++ | 📅 2026-09-16 - High performance simulator for quantum circuits that includes noise models (supported by IBM).
...
* [MQT DDSIM](https://github.com/cda-tum/mqt-ddsim) ⭐ 162 | 🐛 9 | 🌐 C++ | 📅 2026-09-24 - Quantum circuit simulator using decision diagrams as a datastructure. Python interface and Qiskit backend via the [`mqt.ddsim`](https://pypi.org/p/mqt.ddsim) Python package.
...
* [Q](https://github.com/itsubaki/q) ⭐ 283 | 🐛 5 | 🌐 Go | 📅 2026-09-23 - Quantum Computation Simulator written purely in GoLang.
...
* [QuantumToolbox.jl](https://github.com/qutip/QuantumToolbox.jl) ⭐ 172 | 🐛 29 | 🌐 Julia | 📅 2026-09-23 - High-performance, GPU-ready and autodiff-friendly simulations of open quantum systems.
...
* [Stim](https://github.com/quantumlib/Stim) ⭐ 825 | 🐛 93 | 🌐 C++ | 📅 2026-09-22 - Fast stabilizer circuit simulator.
* [qsim](https://github.com/quantumlib/qsim) ⭐ 697 | 🐛 49 | 🌐 C++ | 📅 2026-09-04 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
* [quimb](https://github.com/jcmgray/quimb) ⭐ 669 | 🐛 69 | 🌐 Python | 📅 2026-09-25 - Easy but fast python library for quantum information and many-body calculations, including with tensor networks.
...
* [Tsim](https://github.com/QuEraComputing/tsim) ⭐ 126 | 🐛 8 | 🌐 Python | 📅 2026-09-21 - GPU-accelerated universal quantum circuit sampler via ZX-calculus stabilizer-rank decomposition ([Stim](https://github.com/quantumlib/Stim) ⭐ 825 | 🐛 93 | 🌐 C++ | 📅 2026-09-22-like API, with non-Clifford support).
* [Graphix](https://github.com/TeamGraphix/graphix) ⭐ 118 | 🐛 22 | 🌐 Python | 📅 2026-09-24 - Measurement-Based Quantum Computing (MBQC) compiler, simulator and QPU interface.
...
* [Piquasso](https://github.com/Budapest-Quantum-Computing-Group/piquasso) ⭐ 61 | 🐛 12 | 🌐 Python | 📅 2026-09-24 - A photonic quantum computing simulator library written in Python/C++.
...
* [Dense-Evolution](https://github.com/tatopenn-cell/Dense-Evolution) ⭐ 16 | 🐛 3 | 🌐 Python | 📅 2026-09-24 - NISQ quantum simulation toolkit — JAX-native.
...
* [scpn-quantum-control](https://github.com/anulum/scpn-quantum-control) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-24 - Quantum simulation of coupled Kuramoto-XY oscillators on IBM hardware, with Rust-accelerated Hamiltonian construction, synchronisation witnesses, and Lindblad open-system dynamics.
...
* [Pulser](https://github.com/pasqal-io/Pulser) ⭐ 247 | 🐛 45 | 🌐 Python | 📅 2026-09-24 - Python library for pulse-level/analog control of neutral atom devices.
...
* [ReCirq](https://github.com/quantumlib/ReCirq) ⭐ 309 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modules for running quantum computing applications and experiments through [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,070 | 🐛 125 | 🌐 Python | 📅 2026-09-24.
...
* [TKET](https://github.com/CQCL/tket) ⭐ 316 | 🐛 91 | 🌐 C++ | 📅 2026-09-24 - C++ library for placement, routing, and optimization of quantum circuits (developed by Quantinuum).
* [Catalyst](https://github.com/PennyLaneAI/catalyst) ⭐ 236 | 🐛 328 | 🌐 Python | 📅 2026-09-25 - AOT/JIT compiler for hybrid quantum computing beyond NISQ. Written in MLIR. Python frontend via [PennyLane](https://pennylane.ai).
...
* [MQT QMAP](https://github.com/cda-tum/mqt-qmap) ⭐ 146 | 🐛 20 | 🌐 C++ | 📅 2026-09-24 - Quantum circuit mapping. Clifford synthesis. Compilation for neutral atom architectures. Compatible with Qiskit through the [`mqt.qmap`](https://pypi.org/p/mqt.qmap) Python package.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,830 | 🐛 1,021 | 🌐 Python | 📅 2026-09-24 - Python library for quantum circuit rewriting and optimization (supported by IBM).
* [PyZX](https://github.com/Quantomatic/pyzx) ⭐ 544 | 🐛 33 | 🌐 OpenQASM | 📅 2026-09-17 - Python library for quantum circuit rewriting and optimisation using the ZX-calculus.
* [Mitiq](https://github.com/unitaryfoundation/mitiq) ⭐ 445 | 🐛 100 | 🌐 Python | 📅 2026-09-21 - Cross-platform, quantum error mitigation toolkit and compiler from [Unitary Foundation](https://unitary.foundation/).
...
* [MQT Predictor](https://github.com/cda-tum/mqt-predictor) ⭐ 88 | 🐛 30 | 🌐 Python | 📅 2026-09-24 - RL-based compiler optimization. ML-based device selection. Available via the [`mqt.predictor`](https://pypi.org/p/mqt.predictor) Python package.
...
* [TKET2](https://github.com/CQCL/tket2) ⭐ 61 | 🐛 184 | 🌐 Rust | 📅 2026-09-24 - Rewrite based toolkit for optimization of quantum programs (version 2 of the [TKET](https://github.com/CQCL/tket) ⭐ 316 | 🐛 91 | 🌐 C++ | 📅 2026-09-24 quantum compiler).
...
* [OpenQASM](https://github.com/QISKit/openqasm) ⭐ 1,508 | 🐛 112 | 🌐 Python | 📅 2026-09-02 - Open-source quantum assembly language.
...
* [qiskit-zksf](https://github.com/official-dvl/qiskit-zksf) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-09-12 - Qiskit provider exposing [ZKSF](https://zksf.org) simulation engines and quantum hardware as backends, so existing circuits run by naming a different backend.
* [pennylane-zksf](https://github.com/official-dvl/pennylane-zksf) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - PennyLane device for the [ZKSF](https://zksf.org) engines, so existing PennyLane circuits run by naming a different device, with an error bound reported per run.
...
* [MQT QECC](https://github.com/cda-tum/mqt-qecc) ⭐ 239 | 🐛 13 | 🌐 Python | 📅 2026-09-24 - Synthesis of fault-tolerant circuits. Decoders. Automatic Application of error correcting codes. Available via the [`mqt.qecc`](https://pypi.org/p/mqt.qecc) Python package.
* [Qiskit Experiments](https://github.com/Qiskit-Extensions/qiskit-experiments) ⭐ 197 | 🐛 139 | 🌐 Python | 📅 2026-09-10 - Python package for quantum error correction experiments (supported by IBM).
* [Tesseract Decoder](https://github.com/quantumlib/tesseract-decoder) ⭐ 120 | 🐛 27 | 🌐 C++ | 📅 2026-09-22 - Most Likely Error decoder designed for Low Density Parity Check (LDPC) quantum error-correcting codes.
...
* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,072 | 🐛 109 | 🌐 C | 📅 2026-09-24 - C library for quantum-resistant cryptographic algorithms.
...
* [QRL](https://github.com/theQRL/QRL/) ⭐ 467 | 🐛 50 | 🌐 Python | 📅 2026-09-24 - [Quantum Resistant Ledger](https://theqrl.org/) utilizing hash-based one-time merkle tree signature scheme instead of ECDSA.
...
* [QCoDeS](https://github.com/QCoDeS/Qcodes) ⭐ 459 | 🐛 263 | 🌐 Python | 📅 2026-09-24 - Python-based data acquisition framework for quantum experiments.
...
* [Quantum Nematode](https://github.com/SyntheticBrains/nematode) ⭐ 4 | 🐛 3 | 🌐 Python | 📅 2026-09-24 - C. elegans navigation simulation using quantum variational circuits.
...
* [MQT QuSAT](https://github.com/cda-tum/mqt-qusat) ⭐ 28 | 🐛 2 | 🌐 C++ | 📅 2026-09-24 - Encoding and equivalence checking of Clifford circuits using satisfiablity testing (SAT).
...
* [MQT Debugger](https://github.com/cda-tum/mqt-debugger) ⭐ 21 | 🐛 12 | 🌐 C++ | 📅 2026-09-24 - Debugging quantum circuits with IDE integration based on DAP server.
...
* [MQT Bench](https://github.com/cda-tum/mqt-bench) ⭐ 131 | 🐛 21 | 🌐 Python | 📅 2026-09-24 - Quantum circuit benchmark suite providing benchmark algorithms for different compilation levels. Web application hosted at <https://www.cda.cit.tum.de/mqtbench/>. Also available via the [`mqt.bench`](https://pypi.org/p/mqt.bench) Python package.
...
* [zcc-verify](https://github.com/official-dvl/zksf-zcc-verify) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - Independent checker for ZCC and ZHF simulation-accuracy certificates, recomputing a declared error bound from the measurement the certificate reports, with no dependencies and no account ([protocol](https://doi.org/10.5281/zenodo.21851381)).
...
* [QuPrep](https://github.com/quprep/quprep) ⭐ 3 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - Classical-to-quantum data encoding and preprocessing library for quantum machine learning.

## Abandoned projects

*2+ years of inactivity. Feel free to reanimate, document and contribute to some of this work!*

* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,830 | 🐛 1,021 | 🌐 Python | 📅 2026-09-24.
...
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,830 | 🐛 1,021 | 🌐 Python | 📅 2026-09-24.
