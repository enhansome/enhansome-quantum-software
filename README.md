...
For a curated list of learning resources please check out [desireevl's repo](https://github.com/desireevl/awesome-quantum-computing) ⭐ 3,262 | 🐛 29 | 📅 2024-07-24.
...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,122 | 🐛 539 | 🌐 C++ | 📅 2026-09-01 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,056 | 🐛 108 | 🌐 Python | 📅 2026-08-31 - Framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
* [Forest](https://github.com/rigetticomputing/pyquil) ⭐ 1,497 | 🐛 242 | 🌐 Python | 📅 2026-08-20 - [Rigetti](https://www.rigetti.com/)'s software library for writing, simulating, compiling and executing quantum programs.
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,122 | 🐛 539 | 🌐 C++ | 📅 2026-09-01 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Tequila](https://github.com/aspuru-guzik-group/tequila) ⭐ 439 | 🐛 5 | 🌐 Python | 📅 2026-08-13 - Extensible Quantum Information and Learning Architecture developed by Alan Aspuru-Guzik's group (UofT).
* [blueqat](https://github.com/Blueqat/Blueqat) ⭐ 387 | 🐛 1 | 🌐 Python | 📅 2026-08-29 - Quantum computing SDK.
* [Braket](https://github.com/amazon-braket/amazon-braket-sdk-python) ⭐ 373 | 🐛 30 | 🌐 Python | 📅 2026-08-31 - [Amazon's](https://aws.amazon.com/braket/) fully managed quantum computing service for building quantum algorithms.
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 363 | 🐛 107 | 🌐 Python | 📅 2026-08-31 - An open-source framework for quantum simulation, self-hosted quantum hardware control and calibration.
...
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 293 | 🐛 188 | 🌐 Python | 📅 2026-08-31).
* [Perceval](https://github.com/Quandela/Perceval) ⭐ 207 | 🐛 6 | 🌐 Python | 📅 2026-08-31 - [Quandela](https://www.quandela.com)'s software library for programming realistic photonic quantum computers.
...
* [qsim](https://github.com/quantumlib/qsim) ⭐ 692 | 🐛 49 | 🌐 C++ | 📅 2026-09-01 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
* [Qiskit Aer](https://github.com/Qiskit/qiskit-aer) ⭐ 691 | 🐛 246 | 🌐 C++ | 📅 2026-05-25 - High performance simulator for quantum circuits that includes noise models (supported by IBM).
...
* [Intel Quantum Simulator](https://github.com/intel/intel-qs) ⭐ 263 | 🐛 17 | 🌐 C++ | 📅 2026-08-26 - Distributed qubit register quantum simulator using OpenMP and MPI.
...
* [MQT DDSIM](https://github.com/cda-tum/mqt-ddsim) ⭐ 162 | 🐛 11 | 🌐 C++ | 📅 2026-08-31 - Quantum circuit simulator using decision diagrams as a datastructure. Python interface and Qiskit backend via the [`mqt.ddsim`](https://pypi.org/p/mqt.ddsim) Python package.
...
* [QuantumToolbox.jl](https://github.com/qutip/QuantumToolbox.jl) ⭐ 171 | 🐛 31 | 🌐 Julia | 📅 2026-09-01 - High-performance, GPU-ready and autodiff-friendly simulations of open quantum systems.
...
* [qsim](https://github.com/quantumlib/qsim) ⭐ 692 | 🐛 49 | 🌐 C++ | 📅 2026-09-01 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
* [quimb](https://github.com/jcmgray/quimb) ⭐ 660 | 🐛 68 | 🌐 Python | 📅 2026-08-31 - Easy but fast python library for quantum information and many-body calculations, including with tensor networks.
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 363 | 🐛 107 | 🌐 Python | 📅 2026-08-31 - Framework for quantum simulation with hardware acceleration using just-in-time compilation.
...
* [Tsim](https://github.com/QuEraComputing/tsim) ⭐ 122 | 🐛 8 | 🌐 Python | 📅 2026-08-12 - GPU-accelerated universal quantum circuit sampler via ZX-calculus stabilizer-rank decomposition ([Stim](https://github.com/quantumlib/Stim) ⭐ 816 | 🐛 91 | 🌐 C++ | 📅 2026-08-04-like API, with non-Clifford support).
* [Graphix](https://github.com/TeamGraphix/graphix) ⭐ 115 | 🐛 22 | 🌐 Python | 📅 2026-08-31 - Measurement-Based Quantum Computing (MBQC) compiler, simulator and QPU interface.
...
* [Piquasso](https://github.com/Budapest-Quantum-Computing-Group/piquasso) ⭐ 61 | 🐛 14 | 🌐 Python | 📅 2026-08-01 - A photonic quantum computing simulator library written in Python/C++.
...
* [Dense-Evolution](https://github.com/tatopenn-cell/Dense-Evolution) ⭐ 16 | 🐛 2 | 🌐 Python | 📅 2026-08-31 - NISQ quantum simulation toolkit — JAX-native.
...
* [RustQIP](https://github.com/Renmusxd/RustQIP) ⭐ 312 | 🐛 26 | 🌐 Rust | 📅 2025-12-23 - Rust Quantum Computing library leveraging graph building to build efficient quantum circuit simulations.
...
* [Pulser](https://github.com/pasqal-io/Pulser) ⭐ 241 | 🐛 40 | 🌐 Python | 📅 2026-08-27 - Python library for pulse-level/analog control of neutral atom devices.
...
* [dwave-cloud-client](https://github.com/dwavesystems/dwave-cloud-client) ⭐ 63 | 🐛 79 | 🌐 Python | 📅 2026-07-31 - Min. implementation of the REST interface to communicate with D-Wave's Solver API.
...
* [OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,731 | 🐛 33 | 🌐 Python | 📅 2026-08-31 - Compiling and analyzing quantum algorithm for quantum chemistry simulations.
...
* [Qiskit Nature](https://github.com/Qiskit/qiskit-nature) ⭐ 398 | 🐛 58 | 🌐 Python | 📅 2026-08-13 - Quantum Chemistry including ground state, excited states and dipole moment calculations.
* [Grove](https://github.com/rigetticomputing/grove) ⚠️ Archived - Quantum algorithms implemented using [Rigetti](https://www.rigetti.com/)'s [pyQuil](https://github.com/rigetticomputing/pyquil) ⭐ 1,497 | 🐛 242 | 🌐 Python | 📅 2026-08-20.
* [ReCirq](https://github.com/quantumlib/ReCirq) ⭐ 309 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modules for running quantum computing applications and experiments through [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,056 | 🐛 108 | 🌐 Python | 📅 2026-08-31.
...
* [XACC QChem](https://github.com/ORNL-QCI/xacc-qchem-benchmarks) - QPU Benchmarks for Quantum Chemistry via [XACC](https://github.com/ORNL-QCI/xacc) ⭐ 3 | 🐛 7 | 🌐 C++ | 📅 2025-01-17, [Psi4](http://www.psicode.org/) and [OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,731 | 🐛 33 | 🌐 Python | 📅 2026-08-31.
...
* [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 91 | 🌐 C++ | 📅 2026-08-28 - C++ library for placement, routing, and optimization of quantum circuits (developed by Quantinuum).
* [Catalyst](https://github.com/PennyLaneAI/catalyst) ⭐ 234 | 🐛 305 | 🌐 Python | 📅 2026-09-01 - AOT/JIT compiler for hybrid quantum computing beyond NISQ. Written in MLIR. Python frontend via [PennyLane](https://pennylane.ai).
...
* [MQT QMAP](https://github.com/cda-tum/mqt-qmap) ⭐ 141 | 🐛 23 | 🌐 C++ | 📅 2026-08-31 - Quantum circuit mapping. Clifford synthesis. Compilation for neutral atom architectures. Compatible with Qiskit through the [`mqt.qmap`](https://pypi.org/p/mqt.qmap) Python package.
...
* [MQT SyReC](https://github.com/cda-tum/mqt-syrec) ⭐ 38 | 🐛 20 | 🌐 C++ | 📅 2026-08-31 - HDL-based synthesis of reversible circuits for optimized circuit designs.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,759 | 🐛 1,181 | 🌐 Python | 📅 2026-08-31 - Python library for quantum circuit rewriting and optimization (supported by IBM).
* [PyZX](https://github.com/Quantomatic/pyzx) ⭐ 540 | 🐛 25 | 🌐 OpenQASM | 📅 2026-08-28 - Python library for quantum circuit rewriting and optimisation using the ZX-calculus.
* [Mitiq](https://github.com/unitaryfoundation/mitiq) ⭐ 444 | 🐛 110 | 🌐 Python | 📅 2026-08-31 - Cross-platform, quantum error mitigation toolkit and compiler from [Unitary Foundation](https://unitary.foundation/).
...
* [CleitonForge](https://github.com/cleitonaugusto/CleitonForge) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-08-26 - Differential fuzzer for quantum compilers and simulators (Rust + Python), with a shrinker and an exact-operator oracle.
...
* [TKET2](https://github.com/CQCL/tket2) ⭐ 60 | 🐛 183 | 🌐 Rust | 📅 2026-08-31 - Rewrite based toolkit for optimization of quantum programs (version 2 of the [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 91 | 🌐 C++ | 📅 2026-08-28 quantum compiler).
...
* [Quil](https://arxiv.org/abs/1608.03355) - Open hybrid quantum/classical instruction set currently used by Rigetti. [Parser](https://github.com/rigetticomputing/pyquil/tree/master/pyquil/_parser) ⭐ 1,497 | 🐛 242 | 🌐 Python | 📅 2026-08-20
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 363 | 🐛 107 | 🌐 Python | 📅 2026-08-31 - Qibo provides a platform agnostic quantum hardware control module with drivers for multiple instruments.
...
* [CodingTheory](https://github.com/esabo/CodingTheory) ⭐ 40 | 🐛 12 | 🌐 Julia | 📅 2026-07-11 - Julia package for constructing and analyzing classical and quantum error-correcting codes.
...
* [MQT QECC](https://github.com/cda-tum/mqt-qecc) ⭐ 233 | 🐛 13 | 🌐 Python | 📅 2026-08-31 - Synthesis of fault-tolerant circuits. Decoders. Automatic Application of error correcting codes. Available via the [`mqt.qecc`](https://pypi.org/p/mqt.qecc) Python package.
...
* [Qsurface](https://github.com/watermarkhu/qsurface) ⭐ 81 | 🐛 20 | 🌐 Python | 📅 2026-08-29 - Python package for simulation and visualization of quantum error-correction on surface codes.
* [Chromobius](https://github.com/quantumlib/chromobius) ⭐ 42 | 🐛 6 | 🌐 Python | 📅 2026-08-01 - Python implementation of a "mobius decoder" for color codes used in quantum error correction.
...
* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,047 | 🐛 116 | 🌐 C | 📅 2026-08-31 - C library for quantum-resistant cryptographic algorithms.
...
* [QCoDeS](https://github.com/QCoDeS/Qcodes) ⭐ 457 | 🐛 263 | 🌐 Python | 📅 2026-08-31 - Python-based data acquisition framework for quantum experiments.
* [Qiskit Metal](https://github.com/Qiskit/qiskit-metal) ⭐ 425 | 🐛 29 | 🌐 Jupyter Notebook | 📅 2026-08-11 - Quantum hardware design and analysis.
...
* [MQT Qudits](https://github.com/cda-tum/mqt-qudits) ⭐ 39 | 🐛 4 | 🌐 Python | 📅 2026-08-31 - A framework for research and education for mixed-dimensional qudit quantum computing available via the \[`mqt.qudits`] Python package.
...
* [MQT QCEC](https://github.com/cda-tum/mqt-qcec) ⭐ 117 | 🐛 14 | 🌐 C++ | 📅 2026-08-31 - Equivalence checking of quantum circuits. Verifying compilation flows. Available via the [`mqt.qcec`](https://pypi.org/p/mqt.qcec) package and fully compatible with Qiskit.
* [MQT QuSAT](https://github.com/cda-tum/mqt-qusat) ⭐ 28 | 🐛 3 | 🌐 C++ | 📅 2026-08-31 - Encoding and equivalence checking of Clifford circuits using satisfiablity testing (SAT).
...
* [MQT Debugger](https://github.com/cda-tum/mqt-debugger) ⭐ 21 | 🐛 9 | 🌐 C++ | 📅 2026-08-31 - Debugging quantum circuits with IDE integration based on DAP server.
...
* [toqito](https://github.com/vprusso/toqito) ⭐ 290 | 🐛 3 | 🌐 Python | 📅 2026-08-31 - Framework to study problems pertaining to entanglement theory, nonlocal games, and other aspects of quantum information.
...
* [MQT Problem Solver](https://github.com/cda-tum/mqt-problemsolver) ⭐ 54 | 🐛 4 | 🌐 Python | 📅 2026-08-31 - Automated Framework for Realizing Quantum Computing Solutions.
...
* [PauLie](https://github.com/QPauLie/PauLie) ⭐ 11 | 🐛 20 | 🌐 Python | 📅 2026-08-27 - Library for studying algebraic properties of quantum systems, in particular the dynamical Lie algebra of Pauli string generated dynamics.
...
* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,759 | 🐛 1,181 | 🌐 Python | 📅 2026-08-31.
...
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,759 | 🐛 1,181 | 🌐 Python | 📅 2026-08-31.
