...
For a curated list of learning resources please check out [desireevl's repo](https://github.com/desireevl/awesome-quantum-computing) ⭐ 3,251 | 🐛 27 | 📅 2024-07-24.
...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,111 | 🐛 503 | 🌐 C++ | 📅 2026-08-15 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
* [qpp](https://github.com/softwareQinc/qpp) ⭐ 672 | 🐛 2 | 🌐 C++ | 📅 2026-07-20 - Quantum++ is a modern C++ general purpose quantum computing library, composed solely of template header files.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,047 | 🐛 119 | 🌐 Python | 📅 2026-08-14 - Framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
* [Forest](https://github.com/rigetticomputing/pyquil) ⭐ 1,497 | 🐛 244 | 🌐 Python | 📅 2026-07-29 - [Rigetti](https://www.rigetti.com/)'s software library for writing, simulating, compiling and executing quantum programs.
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,111 | 🐛 503 | 🌐 C++ | 📅 2026-08-15 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
* [ProjectQ](https://github.com/ProjectQ-Framework/ProjectQ) ⭐ 976 | 🐛 41 | 🌐 Python | 📅 2026-08-10 - Hardware-agnostic framework with compiler and simulator with emulation capabilities.
...
* [Ocean](https://github.com/dwavesystems/dwave-ocean-sdk) ⭐ 536 | 🐛 25 | 🌐 Python | 📅 2026-08-10 - [D-Wave System](https://www.dwavesys.com/home)'s suite of tools for solving hard problems with quantum computers.
* [Tequila](https://github.com/aspuru-guzik-group/tequila) ⭐ 436 | 🐛 5 | 🌐 Python | 📅 2026-08-13 - Extensible Quantum Information and Learning Architecture developed by Alan Aspuru-Guzik's group (UofT).
* [blueqat](https://github.com/Blueqat/Blueqat) ⭐ 387 | 🐛 0 | 🌐 Python | 📅 2026-08-02 - Quantum computing SDK.
* [Braket](https://github.com/amazon-braket/amazon-braket-sdk-python) ⭐ 373 | 🐛 31 | 🌐 Python | 📅 2026-08-13 - [Amazon's](https://aws.amazon.com/braket/) fully managed quantum computing service for building quantum algorithms.
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 361 | 🐛 104 | 🌐 Python | 📅 2026-08-11 - An open-source framework for quantum simulation, self-hosted quantum hardware control and calibration.
...
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 288 | 🐛 181 | 🌐 Python | 📅 2026-08-15).
* [Perceval](https://github.com/Quandela/Perceval) ⭐ 206 | 🐛 12 | 🌐 Python | 📅 2026-07-31 - [Quandela](https://www.quandela.com)'s software library for programming realistic photonic quantum computers.
...
* [quantum-os](https://github.com/quantumos-org/quantum-os) ⭐ 95 | 🐛 0 | 🌐 C | 📅 2022-02-05 - Operating system based on Linux kernel for quantum computing.
...
* [Qristal](https://github.com/qbrilliance/qristal) ⭐ 13 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2025-10-20 - Quantum Brilliance's hybrid quantum-classical C++/Python development platform ([docs](https://qristal.readthedocs.io); [core module](https://github.com/qbrilliance/qristal-core) ⭐ 4 | 🐛 0 | 🌐 C++ | 📅 2025-10-20).
* [hybridlane](https://github.com/pnnl/hybridlane) ⭐ 4 | 🐛 9 | 🌐 Python | 📅 2026-08-14 - Full-stack library for mixed-variable (CV-DV) quantum programming across simulators and hardware within PennyLane.
...
* [QuEST](https://github.com/aniabrown/QuEST) ⭐ 483 | 🐛 53 | 🌐 C++ | 📅 2026-07-25 -  Quantum Exact Simulation Toolkit is a high performance multicore simulator of universal quantum circuits.
...
* [qsim](https://github.com/quantumlib/qsim) ⭐ 689 | 🐛 49 | 🌐 C++ | 📅 2026-08-15 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
...
* [Quantum++](https://github.com/softwareqinc/qpp) ⭐ 672 | 🐛 2 | 🌐 C++ | 📅 2026-07-20 - High-performance general purpose quantum simulator (can simulate d-dimensional qudits) ([paper](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0208073)).
...
* [MQT DDSIM](https://github.com/cda-tum/mqt-ddsim) ⭐ 161 | 🐛 11 | 🌐 C++ | 📅 2026-08-15 - Quantum circuit simulator using decision diagrams as a datastructure. Python interface and Qiskit backend via the [`mqt.ddsim`](https://pypi.org/p/mqt.ddsim) Python package.
* [PennyLane Lightning](https://github.com/PennyLaneAI/pennylane-lightning) ⭐ 144 | 🐛 38 | 🌐 C++ | 📅 2026-08-14 - Fast state-vector simulator written in C++. GPU support. Python interface via [PennyLane](https://pennylane.ai).
...
* [QCSim](https://github.com/aromanro/QCSim) ⭐ 103 | 🐛 6 | 🌐 C++ | 📅 2026-08-07 - Quantum computing simulator with many algorithms as examples and tests ([blog post](https://compphys.go.ro/quantum-computing-simulator/)).
...
* [Q](https://github.com/itsubaki/q) ⭐ 281 | 🐛 0 | 🌐 Go | 📅 2026-08-02 - Quantum Computation Simulator written purely in GoLang.
...
* [Quirk](https://github.com/Strilanc/Quirk) ⭐ 1,096 | 🐛 54 | 🌐 JavaScript | 📅 2024-07-16 - Drag-and-drop quantum circuit simulator in your browser.
...
* [Yao.jl](https://github.com/QuantumBFS/Yao.jl) ⭐ 1,039 | 🐛 40 | 🌐 Julia | 📅 2026-08-10 - Extensible, Efficient Quantum Algorithm Design for Humans.
...
* [PauliStrings.jl](https://github.com/nicolasloizeau/PauliStrings.jl) ⭐ 69 | 🐛 18 | 🌐 Julia | 📅 2026-08-15 - Many-body simulations in the Pauli strings representation.
...
* [BosonSampling.jl](https://github.com/benoitseron/BosonSampling.jl) ⭐ 28 | 🐛 8 | 🌐 Julia | 📅 2026-07-24 - Efficient simulation of multiphoton interference.
...
* [Stim](https://github.com/quantumlib/Stim) ⭐ 805 | 🐛 88 | 🌐 C++ | 📅 2026-08-04 - Fast stabilizer circuit simulator.
* [qsim](https://github.com/quantumlib/qsim) ⭐ 689 | 🐛 49 | 🌐 C++ | 📅 2026-08-15 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
* [quimb](https://github.com/jcmgray/quimb) ⭐ 658 | 🐛 69 | 🌐 Python | 📅 2026-08-15 - Easy but fast python library for quantum information and many-body calculations, including with tensor networks.
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 361 | 🐛 104 | 🌐 Python | 📅 2026-08-11 - Framework for quantum simulation with hardware acceleration using just-in-time compilation.
...
* [Tsim](https://github.com/QuEraComputing/tsim) ⭐ 121 | 🐛 9 | 🌐 Python | 📅 2026-08-12 - GPU-accelerated universal quantum circuit sampler via ZX-calculus stabilizer-rank decomposition ([Stim](https://github.com/quantumlib/Stim) ⭐ 805 | 🐛 88 | 🌐 C++ | 📅 2026-08-04-like API, with non-Clifford support).
* [Graphix](https://github.com/TeamGraphix/graphix) ⭐ 115 | 🐛 22 | 🌐 Python | 📅 2026-08-13 - Measurement-Based Quantum Computing (MBQC) compiler, simulator and QPU interface.
...
* [QTop](https://github.com/jacobmarks/QTop) ⭐ 40 | 🐛 2 | 🌐 Python | 📅 2020-02-15 - Simulation and visualization of topological quantum computers.
...
* [Dense-Evolution](https://github.com/tatopenn-cell/Dense-Evolution) ⭐ 10 | 🐛 1 | 🌐 Python | 📅 2026-08-15 - High-performance NISQ statevector simulator with JAX JIT/XLA compilation, optional CuPy GPU acceleration, and built-in zero-noise-extrapolation error mitigation.
...
* [scpn-quantum-control](https://github.com/anulum/scpn-quantum-control) ⭐ 3 | 🐛 12 | 🌐 Python | 📅 2026-08-10 - Quantum simulation of coupled Kuramoto-XY oscillators on IBM hardware, with Rust-accelerated Hamiltonian construction, synchronisation witnesses, and Lindblad open-system dynamics.
...
* [Bloqade](https://github.com/QuEraComputing/Bloqade.jl) ⭐ 212 | 🐛 85 | 🌐 Julia | 📅 2026-04-08 - Package for the quantum computation and quantum simulation based on the neutral-atom architecture.
...
* [minorminer](https://github.com/dwavesystems/minorminer) ⭐ 54 | 🐛 32 | 🌐 Python | 📅 2026-06-16 - Heuristic tool for minor graph embedding.
* [qubovert](https://github.com/jtiosue/qubovert) ⭐ 40 | 🐛 3 | 🌐 Python | 📅 2026-04-13 - Formulating and simulated annealing of Ising, QUBO, and higher order problems with constraints.
...
* [OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,728 | 🐛 34 | 🌐 Python | 📅 2026-08-10 - Compiling and analyzing quantum algorithm for quantum chemistry simulations.
* [QPanda](https://github.com/OriginQ/QPanda-2) ⭐ 1,205 | 🐛 18 | 🌐 C++ | 📅 2024-11-13 - QPanda is a quantum computing framework that can be used to build, run, and optimize quantum algorithms.
...
* [Grove](https://github.com/rigetticomputing/grove) ⭐ 383 | 🐛 50 | 🌐 Python | 📅 2021-12-02 - Quantum algorithms implemented using [Rigetti](https://www.rigetti.com/)'s [pyQuil](https://github.com/rigetticomputing/pyquil) ⭐ 1,497 | 🐛 244 | 🌐 Python | 📅 2026-07-29.
* [ReCirq](https://github.com/quantumlib/ReCirq) ⭐ 309 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modules for running quantum computing applications and experiments through [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,047 | 🐛 119 | 🌐 Python | 📅 2026-08-14.
...
* [QuantumFlow](https://github.com/rigetti/quantumflow) ⭐ 98 | 🐛 0 | 🌐 Python | 📅 2019-06-03 - Quantum Algorithms Development Toolkit e.g. allowing for backpropagation with QAOA.
* [FermiLib](https://github.com/ProjectQ-Framework/FermiLib) ⭐ 90 | 🐛 4 | 🌐 Python | 📅 2018-05-04 - Software for analyzing fermionic quantum simulation algorithms with [ProjectQ](https://github.com/ProjectQ-Framework/ProjectQ) ⭐ 976 | 🐛 41 | 🌐 Python | 📅 2026-08-10.
...
* [XACC QChem](https://github.com/ORNL-QCI/xacc-qchem-benchmarks) - QPU Benchmarks for Quantum Chemistry via [XACC](https://github.com/ORNL-QCI/xacc) ⭐ 3 | 🐛 6 | 🌐 C++ | 📅 2025-01-17, [Psi4](http://www.psicode.org/) and [OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,728 | 🐛 34 | 🌐 Python | 📅 2026-08-10.
...
* [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 91 | 🌐 C++ | 📅 2026-08-13 - C++ library for placement, routing, and optimization of quantum circuits (developed by Quantinuum).
* [Catalyst](https://github.com/PennyLaneAI/catalyst) ⭐ 232 | 🐛 315 | 🌐 Python | 📅 2026-08-15 - AOT/JIT compiler for hybrid quantum computing beyond NISQ. Written in MLIR. Python frontend via [PennyLane](https://pennylane.ai).
...
* [MQT QMAP](https://github.com/cda-tum/mqt-qmap) ⭐ 141 | 🐛 22 | 🌐 C++ | 📅 2026-08-15 - Quantum circuit mapping. Clifford synthesis. Compilation for neutral atom architectures. Compatible with Qiskit through the [`mqt.qmap`](https://pypi.org/p/mqt.qmap) Python package.
...
* [MQT SyReC](https://github.com/cda-tum/mqt-syrec) ⭐ 38 | 🐛 19 | 🌐 C++ | 📅 2026-08-15 - HDL-based synthesis of reversible circuits for optimized circuit designs.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,709 | 🐛 1,141 | 🌐 Python | 📅 2026-08-15 - Python library for quantum circuit rewriting and optimization (supported by IBM).
* [PyZX](https://github.com/Quantomatic/pyzx) ⭐ 539 | 🐛 26 | 🌐 OpenQASM | 📅 2026-08-14 - Python library for quantum circuit rewriting and optimisation using the ZX-calculus.
* [Mitiq](https://github.com/unitaryfoundation/mitiq) ⭐ 441 | 🐛 93 | 🌐 Python | 📅 2026-08-07 - Cross-platform, quantum error mitigation toolkit and compiler from [Unitary Foundation](https://unitary.foundation/).
...
* [MQT Predictor](https://github.com/cda-tum/mqt-predictor) ⭐ 87 | 🐛 27 | 🌐 Python | 📅 2026-08-15 - RL-based compiler optimization. ML-based device selection. Available via the [`mqt.predictor`](https://pypi.org/p/mqt.predictor) Python package.
* [UCC](https://github.com/unitaryfoundation/ucc/) ⭐ 79 | 🐛 51 | 🌐 Python | 📅 2026-08-10 - Unitary Compiler Collection: frontend-agnostic open-source quantum compiler developed by Unitary Foundation.
...
* [MQT IonShuttler](https://github.com/cda-tum/mqt-ion-shuttler) ⭐ 36 | 🐛 3 | 🌐 Python | 📅 2026-08-15 - Exact and heuristic scheduling to manage ion movement within trapped-ion hardware.
...
* [CleitonForge](https://github.com/cleitonaugusto/CleitonForge) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-08-15 - Neutral cross-backend benchmarking layer for quantum circuit simulators (Rust + Python). Discovered a silent Rz gate sign convention disagreement that produces zero QAOA fidelity across backends. Includes a convention normalization transpiler. Preprint: [10.5281/zenodo.21210972](https://doi.org/10.5281/zenodo.21210972).
...
* [TKET2](https://github.com/CQCL/tket2) ⭐ 59 | 🐛 175 | 🌐 Rust | 📅 2026-08-14 - Rewrite based toolkit for optimization of quantum programs (version 2 of the [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 91 | 🌐 C++ | 📅 2026-08-13 quantum compiler).
* [LIFT](https://github.com/rustnew/Lift) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2026-08-05 - Unified compiler framework for AI and quantum computing; its quantum front covers gate decomposition, noise-aware scheduling, qubit layout mapping, real qubit routing (SWAP + BFS), and OpenQASM 3.0 export. Published on [crates.io](https://crates.io/crates/lift-core).
...
* [OpenQASM](https://github.com/QISKit/openqasm) ⭐ 1,497 | 🐛 104 | 🌐 Python | 📅 2026-08-13 - Open-source quantum assembly language.
* [Quil](https://arxiv.org/abs/1608.03355) - Open hybrid quantum/classical instruction set currently used by Rigetti. [Parser](https://github.com/rigetticomputing/pyquil/tree/master/pyquil/_parser) ⭐ 1,497 | 🐛 244 | 🌐 Python | 📅 2026-07-29
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 361 | 🐛 104 | 🌐 Python | 📅 2026-08-11 - Qibo provides a platform agnostic quantum hardware control module with drivers for multiple instruments.
...
* [Tesseract Decoder](https://github.com/quantumlib/tesseract-decoder) ⭐ 112 | 🐛 30 | 🌐 C++ | 📅 2026-08-13 - Most Likely Error decoder designed for Low Density Parity Check (LDPC) quantum error-correcting codes.
...
* [MQT QECC](https://github.com/cda-tum/mqt-qecc) ⭐ 231 | 🐛 16 | 🌐 Python | 📅 2026-08-15 - Synthesis of fault-tolerant circuits. Decoders. Automatic Application of error correcting codes. Available via the [`mqt.qecc`](https://pypi.org/p/mqt.qecc) Python package.
...
* [Tesseract Decoder](https://github.com/quantumlib/tesseract-decoder) ⭐ 112 | 🐛 30 | 🌐 C++ | 📅 2026-08-13 - Most Likely Error decoder designed for Low Density Parity Check (LDPC) quantum error-correcting codes.
* [qecsim](https://github.com/qecsim/qecsim) ⭐ 95 | 🐛 2 | 🌐 Python | 📅 2021-08-05 - Python package for simulating quantum error correction using stabilizer codes.
* [Qsurface](https://github.com/watermarkhu/qsurface) ⭐ 82 | 🐛 20 | 🌐 Python | 📅 2026-08-04 - Python package for simulation and visualization of quantum error-correction on surface codes.
...
* [autoq-qec](https://github.com/Ronaldoengenhariadacomputacao/autoq-qec) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-01 - Multi-code fault-tolerant QEC resource estimator for arbitrary Qiskit circuits (Surface Code, Floquet Code, Bacon-Shor, Steane).

## Quantum and post-quantum cryptography

**C**

* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,036 | 🐛 113 | 🌐 C | 📅 2026-08-12 - C library for quantum-resistant cryptographic algorithms.
...
* [QRL](https://github.com/theQRL/QRL/) ⭐ 465 | 🐛 50 | 🌐 Python | 📅 2026-08-08 - [Quantum Resistant Ledger](https://theqrl.org/) utilizing hash-based one-time merkle tree signature scheme instead of ECDSA.
...
* [QCoDeS](https://github.com/QCoDeS/Qcodes) ⭐ 454 | 🐛 275 | 🌐 Python | 📅 2026-08-14 - Python-based data acquisition framework for quantum experiments.
* [Qiskit Metal](https://github.com/Qiskit/qiskit-metal) ⭐ 422 | 🐛 30 | 🌐 Jupyter Notebook | 📅 2026-08-11 - Quantum hardware design and analysis.
...
* [PyRPL](https://github.com/lneuhaus/pyrpl) ⭐ 204 | 🐛 157 | 🌐 HTML | 📅 2026-08-09 - Turn your RedPitaya into a powerful DSP device, suitable as a digital lockbox and measurement device in quantum optics.
...
* [MQT Qudits](https://github.com/cda-tum/mqt-qudits) ⭐ 39 | 🐛 4 | 🌐 Python | 📅 2026-08-15 - A framework for research and education for mixed-dimensional qudit quantum computing available via the \[`mqt.qudits`] Python package.
...
* [MQT QCEC](https://github.com/cda-tum/mqt-qcec) ⭐ 117 | 🐛 13 | 🌐 C++ | 📅 2026-08-15 - Equivalence checking of quantum circuits. Verifying compilation flows. Available via the [`mqt.qcec`](https://pypi.org/p/mqt.qcec) package and fully compatible with Qiskit.
* [MQT QuSAT](https://github.com/cda-tum/mqt-qusat) ⭐ 28 | 🐛 2 | 🌐 C++ | 📅 2026-08-15 - Encoding and equivalence checking of Clifford circuits using satisfiablity testing (SAT).
* [MQT DDVis](https://github.com/cda-tum/mqt-ddvis) ⭐ 27 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-15 - Installation-free web-tool that visualizes quantum decision diagrams for classical simulation and verification. Hosted at <https://www.cda.cit.tum.de/app/ddvis/>.
* [MQT Debugger](https://github.com/cda-tum/mqt-debugger) ⭐ 21 | 🐛 7 | 🌐 C++ | 📅 2026-08-15 - Debugging quantum circuits with IDE integration based on DAP server.
...
* [Covalent](https://github.com/AgnostiqHQ/covalent) ⭐ 867 | 🐛 100 | 🌐 Python | 📅 2026-08-10 - Tool for running high performance/quantum workflows on advanced computing hardwares.
* [toqito](https://github.com/vprusso/toqito) ⭐ 290 | 🐛 3 | 🌐 Python | 📅 2026-08-15 - Framework to study problems pertaining to entanglement theory, nonlocal games, and other aspects of quantum information.
* [MQT Bench](https://github.com/cda-tum/mqt-bench) ⭐ 126 | 🐛 19 | 🌐 Python | 📅 2026-08-15 - Quantum circuit benchmark suite providing benchmark algorithms for different compilation levels. Web application hosted at <https://www.cda.cit.tum.de/mqtbench/>. Also available via the [`mqt.bench`](https://pypi.org/p/mqt.bench) Python package.
* [ZXLive](https://github.com/Quantomatic/zxlive) ⭐ 101 | 🐛 57 | 🌐 Python | 📅 2026-08-15 - GUI editor for ZX diagrams.
...
* [MQT Problem Solver](https://github.com/cda-tum/mqt-problemsolver) ⭐ 54 | 🐛 6 | 🌐 Python | 📅 2026-08-15 - Automated Framework for Realizing Quantum Computing Solutions.
...
* [PauLie](https://github.com/QPauLie/PauLie) ⭐ 11 | 🐛 22 | 🌐 Python | 📅 2026-08-07 - Library for studying algebraic properties of quantum systems, in particular the dynamical Lie algebra of Pauli string generated dynamics.
...
* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,709 | 🐛 1,141 | 🌐 Python | 📅 2026-08-15.
...
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,709 | 🐛 1,141 | 🌐 Python | 📅 2026-08-15.
