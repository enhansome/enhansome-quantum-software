...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,118 | 🐛 527 | 🌐 C++ | 📅 2026-08-23 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 289 | 🐛 182 | 🌐 Python | 📅 2026-08-23).
...
* [Tsim](https://github.com/QuEraComputing/tsim) ⭐ 122 | 🐛 8 | 🌐 Python | 📅 2026-08-12 - GPU-accelerated universal quantum circuit sampler via ZX-calculus stabilizer-rank decomposition ([Stim](https://github.com/quantumlib/Stim) ⭐ 811 | 🐛 88 | 🌐 C++ | 📅 2026-08-04-like API, with non-Clifford support).
...
* [Dense-Evolution](https://github.com/tatopenn-cell/Dense-Evolution) ⭐ 11 | 🐛 3 | 🌐 Python | 📅 2026-08-23 - High-performance NISQ statevector simulator with JAX JIT/XLA compilation, optional CuPy GPU acceleration, and built-in zero-noise-extrapolation error mitigation.
...
* [Pulser](https://github.com/pasqal-io/Pulser) ⭐ 239 | 🐛 39 | 🌐 Python | 📅 2026-08-21 - Python library for pulse-level/analog control of neutral atom devices.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,736 | 🐛 1,148 | 🌐 Python | 📅 2026-08-23 - Python library for quantum circuit rewriting and optimization (supported by IBM).
...
* [MQT Predictor](https://github.com/cda-tum/mqt-predictor) ⭐ 87 | 🐛 25 | 🌐 Python | 📅 2026-08-23 - RL-based compiler optimization. ML-based device selection. Available via the [`mqt.predictor`](https://pypi.org/p/mqt.predictor) Python package.
...
* [TKET2](https://github.com/CQCL/tket2) ⭐ 59 | 🐛 183 | 🌐 Rust | 📅 2026-08-21 - Rewrite based toolkit for optimization of quantum programs (version 2 of the [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 92 | 🌐 C++ | 📅 2026-08-18 quantum compiler).
...
* [OpenQASM](https://github.com/QISKit/openqasm) ⭐ 1,501 | 🐛 105 | 🌐 Python | 📅 2026-08-17 - Open-source quantum assembly language.
...
* [MQT QECC](https://github.com/cda-tum/mqt-qecc) ⭐ 233 | 🐛 12 | 🌐 Python | 📅 2026-08-23 - Synthesis of fault-tolerant circuits. Decoders. Automatic Application of error correcting codes. Available via the [`mqt.qecc`](https://pypi.org/p/mqt.qecc) Python package.
...
* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,040 | 🐛 114 | 🌐 C | 📅 2026-08-23 - C library for quantum-resistant cryptographic algorithms.
...
* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,736 | 🐛 1,148 | 🌐 Python | 📅 2026-08-23.
...
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,736 | 🐛 1,148 | 🌐 Python | 📅 2026-08-23.
