...
For a curated list of learning resources please check out [desireevl's repo](https://github.com/desireevl/awesome-quantum-computing) ⭐ 3,267 | 🐛 30 | 📅 2024-07-24.
...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,126 | 🐛 547 | 🌐 C++ | 📅 2026-09-09 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,056 | 🐛 107 | 🌐 Python | 📅 2026-09-08 - Framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 365 | 🐛 106 | 🌐 Python | 📅 2026-09-08 - An open-source framework for quantum simulation, self-hosted quantum hardware control and calibration.
...
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 294 | 🐛 204 | 🌐 Python | 📅 2026-09-08).
...
* [qsim](https://github.com/quantumlib/qsim) ⭐ 695 | 🐛 48 | 🌐 C++ | 📅 2026-09-04 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
...
* [PennyLane Lightning](https://github.com/PennyLaneAI/pennylane-lightning) ⭐ 146 | 🐛 41 | 🌐 C++ | 📅 2026-09-02 - Fast state-vector simulator written in C++. GPU support. Python interface via [PennyLane](https://pennylane.ai).
...
* [Yao.jl](https://github.com/QuantumBFS/Yao.jl) ⭐ 1,041 | 🐛 30 | 🌐 Julia | 📅 2026-09-08 - Extensible, Efficient Quantum Algorithm Design for Humans.
...
* [qsim](https://github.com/quantumlib/qsim) ⭐ 695 | 🐛 48 | 🌐 C++ | 📅 2026-09-04 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
* [quimb](https://github.com/jcmgray/quimb) ⭐ 664 | 🐛 68 | 🌐 Python | 📅 2026-09-09 - Easy but fast python library for quantum information and many-body calculations, including with tensor networks.
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 365 | 🐛 106 | 🌐 Python | 📅 2026-09-08 - Framework for quantum simulation with hardware acceleration using just-in-time compilation.
...
* [Tsim](https://github.com/QuEraComputing/tsim) ⭐ 125 | 🐛 11 | 🌐 Python | 📅 2026-09-04 - GPU-accelerated universal quantum circuit sampler via ZX-calculus stabilizer-rank decomposition ([Stim](https://github.com/quantumlib/Stim) ⭐ 816 | 🐛 92 | 🌐 C++ | 📅 2026-08-04-like API, with non-Clifford support).
* [Graphix](https://github.com/TeamGraphix/graphix) ⭐ 115 | 🐛 22 | 🌐 Python | 📅 2026-09-06 - Measurement-Based Quantum Computing (MBQC) compiler, simulator and QPU interface.
...
* [Dense-Evolution](https://github.com/tatopenn-cell/Dense-Evolution) ⭐ 15 | 🐛 5 | 🌐 Python | 📅 2026-09-08 - NISQ quantum simulation toolkit — JAX-native.
...
* [Pulser](https://github.com/pasqal-io/Pulser) ⭐ 243 | 🐛 39 | 🌐 Python | 📅 2026-09-08 - Python library for pulse-level/analog control of neutral atom devices.
...
* [ReCirq](https://github.com/quantumlib/ReCirq) ⭐ 309 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modules for running quantum computing applications and experiments through [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,056 | 🐛 107 | 🌐 Python | 📅 2026-09-08.
...
* [pyRiemann-qiskit](https://github.com/pyRiemann/pyRiemann-qiskit) ⭐ 30 | 🐛 15 | 🌐 Python | 📅 2026-09-08 - Library for machine learning and quantum programming based on pyRiemann and Qiskit projects.
...
* [Catalyst](https://github.com/PennyLaneAI/catalyst) ⭐ 234 | 🐛 320 | 🌐 Python | 📅 2026-09-09 - AOT/JIT compiler for hybrid quantum computing beyond NISQ. Written in MLIR. Python frontend via [PennyLane](https://pennylane.ai).
...
* [MQT QMAP](https://github.com/cda-tum/mqt-qmap) ⭐ 142 | 🐛 23 | 🌐 C++ | 📅 2026-09-08 - Quantum circuit mapping. Clifford synthesis. Compilation for neutral atom architectures. Compatible with Qiskit through the [`mqt.qmap`](https://pypi.org/p/mqt.qmap) Python package.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,786 | 🐛 1,178 | 🌐 Python | 📅 2026-09-08 - Python library for quantum circuit rewriting and optimization (supported by IBM).
* [PyZX](https://github.com/Quantomatic/pyzx) ⭐ 542 | 🐛 26 | 🌐 OpenQASM | 📅 2026-09-08 - Python library for quantum circuit rewriting and optimisation using the ZX-calculus.
* [Mitiq](https://github.com/unitaryfoundation/mitiq) ⭐ 445 | 🐛 104 | 🌐 Python | 📅 2026-09-08 - Cross-platform, quantum error mitigation toolkit and compiler from [Unitary Foundation](https://unitary.foundation/).
...
* [CleitonForge](https://github.com/cleitonaugusto/CleitonForge) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-09-08 - Differential fuzzer for quantum compilers and simulators (Rust + Python), with a shrinker and an exact-operator oracle.
...
* [TKET2](https://github.com/CQCL/tket2) ⭐ 60 | 🐛 174 | 🌐 Rust | 📅 2026-09-08 - Rewrite based toolkit for optimization of quantum programs (version 2 of the [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 91 | 🌐 C++ | 📅 2026-09-03 quantum compiler).
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 365 | 🐛 106 | 🌐 Python | 📅 2026-09-08 - Qibo provides a platform agnostic quantum hardware control module with drivers for multiple instruments.
...
* [Tesseract Decoder](https://github.com/quantumlib/tesseract-decoder) ⭐ 118 | 🐛 30 | 🌐 C++ | 📅 2026-09-08 - Most Likely Error decoder designed for Low Density Parity Check (LDPC) quantum error-correcting codes.

**Julia**

* [CodingTheory](https://github.com/esabo/CodingTheory) ⭐ 41 | 🐛 12 | 🌐 Julia | 📅 2026-09-08 - Julia package for constructing and analyzing classical and quantum error-correcting codes.
...
* [Qiskit Experiments](https://github.com/Qiskit-Extensions/qiskit-experiments) ⭐ 196 | 🐛 140 | 🌐 Python | 📅 2026-08-28 - Python package for quantum error correction experiments (supported by IBM).
* [Tesseract Decoder](https://github.com/quantumlib/tesseract-decoder) ⭐ 118 | 🐛 30 | 🌐 C++ | 📅 2026-09-08 - Most Likely Error decoder designed for Low Density Parity Check (LDPC) quantum error-correcting codes.
...
* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,060 | 🐛 112 | 🌐 C | 📅 2026-09-08 - C library for quantum-resistant cryptographic algorithms.
...
* [QRL](https://github.com/theQRL/QRL/) ⭐ 467 | 🐛 55 | 🌐 Python | 📅 2026-08-29 - [Quantum Resistant Ledger](https://theqrl.org/) utilizing hash-based one-time merkle tree signature scheme instead of ECDSA.
...
* [QCoDeS](https://github.com/QCoDeS/Qcodes) ⭐ 458 | 🐛 282 | 🌐 Python | 📅 2026-09-08 - Python-based data acquisition framework for quantum experiments.
...
* [PyRPL](https://github.com/lneuhaus/pyrpl) ⭐ 210 | 🐛 156 | 🌐 HTML | 📅 2026-08-19 - Turn your RedPitaya into a powerful DSP device, suitable as a digital lockbox and measurement device in quantum optics.
...
* [MQT Qudits](https://github.com/cda-tum/mqt-qudits) ⭐ 39 | 🐛 4 | 🌐 Python | 📅 2026-09-08 - A framework for research and education for mixed-dimensional qudit quantum computing available via the \[`mqt.qudits`] Python package.
...
* [Quantum Nematode](https://github.com/SyntheticBrains/nematode) ⭐ 4 | 🐛 4 | 🌐 Python | 📅 2026-09-08 - C. elegans navigation simulation using quantum variational circuits.
...
* [MQT Debugger](https://github.com/cda-tum/mqt-debugger) ⭐ 21 | 🐛 16 | 🌐 C++ | 📅 2026-09-07 - Debugging quantum circuits with IDE integration based on DAP server.
...
* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,786 | 🐛 1,178 | 🌐 Python | 📅 2026-09-08.
...
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,786 | 🐛 1,178 | 🌐 Python | 📅 2026-09-08.
