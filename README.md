...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,121 | 🐛 534 | 🌐 C++ | 📅 2026-08-28 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,054 | 🐛 109 | 🌐 Python | 📅 2026-08-28 - Framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
...
* [Braket](https://github.com/amazon-braket/amazon-braket-sdk-python) ⭐ 374 | 🐛 37 | 🌐 Python | 📅 2026-08-24 - [Amazon's](https://aws.amazon.com/braket/) fully managed quantum computing service for building quantum algorithms.
...
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 293 | 🐛 186 | 🌐 Python | 📅 2026-08-28).
* [Perceval](https://github.com/Quandela/Perceval) ⭐ 207 | 🐛 10 | 🌐 Python | 📅 2026-08-27 - [Quandela](https://www.quandela.com)'s software library for programming realistic photonic quantum computers.
...
* [Qiskit Aer](https://github.com/Qiskit/qiskit-aer) ⭐ 690 | 🐛 246 | 🌐 C++ | 📅 2026-05-25 - High performance simulator for quantum circuits that includes noise models (supported by IBM).
...
* [Qrack](https://github.com/vm6502q/qrack) ⭐ 231 | 🐛 11 | 🌐 C++ | 📅 2026-08-12 - Comprehensive qubit and gate implementation for developing universal virtual quantum processors.
* [MQT DDSIM](https://github.com/cda-tum/mqt-ddsim) ⭐ 162 | 🐛 11 | 🌐 C++ | 📅 2026-08-27 - Quantum circuit simulator using decision diagrams as a datastructure. Python interface and Qiskit backend via the [`mqt.ddsim`](https://pypi.org/p/mqt.ddsim) Python package.
...
* [QCSim](https://github.com/aromanro/QCSim) ⭐ 103 | 🐛 6 | 🌐 C++ | 📅 2026-08-27 - Quantum computing simulator with many algorithms as examples and tests ([blog post](https://compphys.go.ro/quantum-computing-simulator/)).
...
* [Q](https://github.com/itsubaki/q) ⭐ 282 | 🐛 1 | 🌐 Go | 📅 2026-08-26 - Quantum Computation Simulator written purely in GoLang.
...
* [qsim](https://github.com/quantumlib/qsim) ⭐ 692 | 🐛 49 | 🌐 C++ | 📅 2026-08-15 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
* [quimb](https://github.com/jcmgray/quimb) ⭐ 659 | 🐛 68 | 🌐 Python | 📅 2026-08-27 - Easy but fast python library for quantum information and many-body calculations, including with tensor networks.
...
* [Graphix](https://github.com/TeamGraphix/graphix) ⭐ 115 | 🐛 21 | 🌐 Python | 📅 2026-08-27 - Measurement-Based Quantum Computing (MBQC) compiler, simulator and QPU interface.
...
* [scpn-quantum-control](https://github.com/anulum/scpn-quantum-control) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - Quantum simulation of coupled Kuramoto-XY oscillators on IBM hardware, with Rust-accelerated Hamiltonian construction, synchronisation witnesses, and Lindblad open-system dynamics.
...
* [qqa](https://github.com/Yuma-Ichikawa/QQA4CO) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-08-28 - GPU-parallel Quasi-Quantum Annealing toolkit for QUBO and Ising combinatorial optimisation, with PI-GNN / CPRA neural backends and a Simulated Annealing baseline, all under a single PyTorch API.
...
* [ReCirq](https://github.com/quantumlib/ReCirq) ⭐ 309 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modules for running quantum computing applications and experiments through [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,054 | 🐛 109 | 🌐 Python | 📅 2026-08-28.
...
* [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 92 | 🌐 C++ | 📅 2026-08-27 - C++ library for placement, routing, and optimization of quantum circuits (developed by Quantinuum).
* [Catalyst](https://github.com/PennyLaneAI/catalyst) ⭐ 234 | 🐛 311 | 🌐 Python | 📅 2026-08-28 - AOT/JIT compiler for hybrid quantum computing beyond NISQ. Written in MLIR. Python frontend via [PennyLane](https://pennylane.ai).
...
* [MQT QMAP](https://github.com/cda-tum/mqt-qmap) ⭐ 141 | 🐛 23 | 🌐 C++ | 📅 2026-08-28 - Quantum circuit mapping. Clifford synthesis. Compilation for neutral atom architectures. Compatible with Qiskit through the [`mqt.qmap`](https://pypi.org/p/mqt.qmap) Python package.
...
* [MQT SyReC](https://github.com/cda-tum/mqt-syrec) ⭐ 38 | 🐛 20 | 🌐 C++ | 📅 2026-08-27 - HDL-based synthesis of reversible circuits for optimized circuit designs.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,754 | 🐛 1,161 | 🌐 Python | 📅 2026-08-28 - Python library for quantum circuit rewriting and optimization (supported by IBM).
* [PyZX](https://github.com/Quantomatic/pyzx) ⭐ 540 | 🐛 25 | 🌐 OpenQASM | 📅 2026-08-24 - Python library for quantum circuit rewriting and optimisation using the ZX-calculus.
...
* [MQT Predictor](https://github.com/cda-tum/mqt-predictor) ⭐ 87 | 🐛 27 | 🌐 Python | 📅 2026-08-27 - RL-based compiler optimization. ML-based device selection. Available via the [`mqt.predictor`](https://pypi.org/p/mqt.predictor) Python package.
...
* [MQT IonShuttler](https://github.com/cda-tum/mqt-ion-shuttler) ⭐ 36 | 🐛 2 | 🌐 Python | 📅 2026-08-27 - Exact and heuristic scheduling to manage ion movement within trapped-ion hardware.
...
* [TKET2](https://github.com/CQCL/tket2) ⭐ 60 | 🐛 187 | 🌐 Rust | 📅 2026-08-28 - Rewrite based toolkit for optimization of quantum programs (version 2 of the [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 92 | 🌐 C++ | 📅 2026-08-27 quantum compiler).
...
* [MQT QECC](https://github.com/cda-tum/mqt-qecc) ⭐ 233 | 🐛 13 | 🌐 Python | 📅 2026-08-27 - Synthesis of fault-tolerant circuits. Decoders. Automatic Application of error correcting codes. Available via the [`mqt.qecc`](https://pypi.org/p/mqt.qecc) Python package.
* [Qiskit Experiments](https://github.com/Qiskit-Extensions/qiskit-experiments) ⭐ 196 | 🐛 140 | 🌐 Python | 📅 2026-08-25 - Python package for quantum error correction experiments (supported by IBM).
* [Tesseract Decoder](https://github.com/quantumlib/tesseract-decoder) ⭐ 114 | 🐛 31 | 🌐 C++ | 📅 2026-08-27 - Most Likely Error decoder designed for Low Density Parity Check (LDPC) quantum error-correcting codes.
...
* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,046 | 🐛 116 | 🌐 C | 📅 2026-08-27 - C library for quantum-resistant cryptographic algorithms.
...
* [QCoDeS](https://github.com/QCoDeS/Qcodes) ⭐ 457 | 🐛 264 | 🌐 Python | 📅 2026-08-28 - Python-based data acquisition framework for quantum experiments.
...
* [MQT Qudits](https://github.com/cda-tum/mqt-qudits) ⭐ 39 | 🐛 4 | 🌐 Python | 📅 2026-08-27 - A framework for research and education for mixed-dimensional qudit quantum computing available via the \[`mqt.qudits`] Python package.
...
* [MQT QCEC](https://github.com/cda-tum/mqt-qcec) ⭐ 117 | 🐛 14 | 🌐 C++ | 📅 2026-08-27 - Equivalence checking of quantum circuits. Verifying compilation flows. Available via the [`mqt.qcec`](https://pypi.org/p/mqt.qcec) package and fully compatible with Qiskit.
* [MQT QuSAT](https://github.com/cda-tum/mqt-qusat) ⭐ 28 | 🐛 3 | 🌐 C++ | 📅 2026-08-27 - Encoding and equivalence checking of Clifford circuits using satisfiablity testing (SAT).
* [MQT DDVis](https://github.com/cda-tum/mqt-ddvis) ⭐ 27 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-24 - Installation-free web-tool that visualizes quantum decision diagrams for classical simulation and verification. Hosted at <https://www.cda.cit.tum.de/app/ddvis/>.
* [MQT Debugger](https://github.com/cda-tum/mqt-debugger) ⭐ 21 | 🐛 9 | 🌐 C++ | 📅 2026-08-27 - Debugging quantum circuits with IDE integration based on DAP server.
...
* [MQT Bench](https://github.com/cda-tum/mqt-bench) ⭐ 127 | 🐛 19 | 🌐 Python | 📅 2026-08-27 - Quantum circuit benchmark suite providing benchmark algorithms for different compilation levels. Web application hosted at <https://www.cda.cit.tum.de/mqtbench/>. Also available via the [`mqt.bench`](https://pypi.org/p/mqt.bench) Python package.
...
* [MQT Problem Solver](https://github.com/cda-tum/mqt-problemsolver) ⭐ 54 | 🐛 4 | 🌐 Python | 📅 2026-08-27 - Automated Framework for Realizing Quantum Computing Solutions.
...
* [QDataSet](https://github.com/eperrier/QDataSet) ⭐ 136 | 🐛 1 | 🌐 Python | 📅 2021-08-17 - Quantum datasets for the training and development of QML algorithms.
...
* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,754 | 🐛 1,161 | 🌐 Python | 📅 2026-08-28.
...
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,754 | 🐛 1,161 | 🌐 Python | 📅 2026-08-28.
