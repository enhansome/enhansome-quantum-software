...
For a curated list of learning resources please check out [desireevl's repo](https://github.com/desireevl/awesome-quantum-computing) ⭐ 3,274 | 🐛 30 | 📅 2024-07-24.
...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,143 | 🐛 530 | 🌐 C++ | 📅 2026-09-22 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,065 | 🐛 126 | 🌐 Python | 📅 2026-09-18 - Framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
* [Forest](https://github.com/rigetticomputing/pyquil) ⭐ 1,497 | 🐛 242 | 🌐 Python | 📅 2026-09-22 - [Rigetti](https://www.rigetti.com/)'s software library for writing, simulating, compiling and executing quantum programs.
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,143 | 🐛 530 | 🌐 C++ | 📅 2026-09-22 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Tequila](https://github.com/aspuru-guzik-group/tequila) ⭐ 441 | 🐛 4 | 🌐 Python | 📅 2026-09-21 - Extensible Quantum Information and Learning Architecture developed by Alan Aspuru-Guzik's group (UofT).
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 366 | 🐛 106 | 🌐 Python | 📅 2026-09-21 - An open-source framework for quantum simulation, self-hosted quantum hardware control and calibration.
...
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 296 | 🐛 208 | 🌐 Python | 📅 2026-09-21).
...
* [QuEST](https://github.com/aniabrown/QuEST) ⭐ 489 | 🐛 55 | 🌐 C++ | 📅 2026-09-21 -  Quantum Exact Simulation Toolkit is a high performance multicore simulator of universal quantum circuits.
...
* [Qiskit Aer](https://github.com/Qiskit/qiskit-aer) ⭐ 697 | 🐛 253 | 🌐 C++ | 📅 2026-09-16 - High performance simulator for quantum circuits that includes noise models (supported by IBM).
...
* [MQT DDSIM](https://github.com/cda-tum/mqt-ddsim) ⭐ 162 | 🐛 9 | 🌐 C++ | 📅 2026-09-21 - Quantum circuit simulator using decision diagrams as a datastructure. Python interface and Qiskit backend via the [`mqt.ddsim`](https://pypi.org/p/mqt.ddsim) Python package.
...
* [QuantumToolbox.jl](https://github.com/qutip/QuantumToolbox.jl) ⭐ 172 | 🐛 28 | 🌐 Julia | 📅 2026-09-20 - High-performance, GPU-ready and autodiff-friendly simulations of open quantum systems.
...
* [Stim](https://github.com/quantumlib/Stim) ⭐ 821 | 🐛 92 | 🌐 C++ | 📅 2026-09-22 - Fast stabilizer circuit simulator.
* [qsim](https://github.com/quantumlib/qsim) ⭐ 697 | 🐛 49 | 🌐 C++ | 📅 2026-09-04 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 366 | 🐛 106 | 🌐 Python | 📅 2026-09-21 - Framework for quantum simulation with hardware acceleration using just-in-time compilation.
...
* [Tsim](https://github.com/QuEraComputing/tsim) ⭐ 126 | 🐛 8 | 🌐 Python | 📅 2026-09-21 - GPU-accelerated universal quantum circuit sampler via ZX-calculus stabilizer-rank decomposition ([Stim](https://github.com/quantumlib/Stim) ⭐ 821 | 🐛 92 | 🌐 C++ | 📅 2026-09-22-like API, with non-Clifford support).
* [Graphix](https://github.com/TeamGraphix/graphix) ⭐ 118 | 🐛 20 | 🌐 Python | 📅 2026-09-19 - Measurement-Based Quantum Computing (MBQC) compiler, simulator and QPU interface.
...
* [scpn-quantum-control](https://github.com/anulum/scpn-quantum-control) ⭐ 3 | 🐛 6 | 🌐 Python | 📅 2026-09-21 - Quantum simulation of coupled Kuramoto-XY oscillators on IBM hardware, with Rust-accelerated Hamiltonian construction, synchronisation witnesses, and Lindblad open-system dynamics.
...
* [RustQIP](https://github.com/Renmusxd/RustQIP) ⭐ 315 | 🐛 26 | 🌐 Rust | 📅 2025-12-23 - Rust Quantum Computing library leveraging graph building to build efficient quantum circuit simulations.
...
* [Pulser](https://github.com/pasqal-io/Pulser) ⭐ 246 | 🐛 44 | 🌐 Python | 📅 2026-09-21 - Python library for pulse-level/analog control of neutral atom devices.
...
* [dwave\_networkx](https://github.com/dwavesystems/dwave_networkx) ⭐ 95 | 🐛 37 | 🌐 Python | 📅 2026-09-21 - Exploration and analysis of network graphs.
...
* [OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,736 | 🐛 33 | 🌐 Python | 📅 2026-09-21 - Compiling and analyzing quantum algorithm for quantum chemistry simulations.
...
* [Grove](https://github.com/rigetticomputing/grove) ⚠️ Archived - Quantum algorithms implemented using [Rigetti](https://www.rigetti.com/)'s [pyQuil](https://github.com/rigetticomputing/pyquil) ⭐ 1,497 | 🐛 242 | 🌐 Python | 📅 2026-09-22.
* [ReCirq](https://github.com/quantumlib/ReCirq) ⭐ 309 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modules for running quantum computing applications and experiments through [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,065 | 🐛 126 | 🌐 Python | 📅 2026-09-18.
...
* [XACC QChem](https://github.com/ORNL-QCI/xacc-qchem-benchmarks) - QPU Benchmarks for Quantum Chemistry via [XACC](https://github.com/ORNL-QCI/xacc) ⭐ 3 | 🐛 7 | 🌐 C++ | 📅 2025-01-17, [Psi4](http://www.psicode.org/) and [OpenFermion](https://github.com/quantumlib/OpenFermion) ⭐ 1,736 | 🐛 33 | 🌐 Python | 📅 2026-09-21.
...
* [TKET](https://github.com/CQCL/tket) ⭐ 316 | 🐛 92 | 🌐 C++ | 📅 2026-09-21 - C++ library for placement, routing, and optimization of quantum circuits (developed by Quantinuum).
* [Catalyst](https://github.com/PennyLaneAI/catalyst) ⭐ 234 | 🐛 328 | 🌐 Python | 📅 2026-09-22 - AOT/JIT compiler for hybrid quantum computing beyond NISQ. Written in MLIR. Python frontend via [PennyLane](https://pennylane.ai).
...
* [MQT QMAP](https://github.com/cda-tum/mqt-qmap) ⭐ 146 | 🐛 20 | 🌐 C++ | 📅 2026-09-21 - Quantum circuit mapping. Clifford synthesis. Compilation for neutral atom architectures. Compatible with Qiskit through the [`mqt.qmap`](https://pypi.org/p/mqt.qmap) Python package.
...
* [MQT SyReC](https://github.com/cda-tum/mqt-syrec) ⭐ 39 | 🐛 19 | 🌐 C++ | 📅 2026-09-21 - HDL-based synthesis of reversible circuits for optimized circuit designs.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,821 | 🐛 1,037 | 🌐 Python | 📅 2026-09-21 - Python library for quantum circuit rewriting and optimization (supported by IBM).
...
* [Mitiq](https://github.com/unitaryfoundation/mitiq) ⭐ 445 | 🐛 99 | 🌐 Python | 📅 2026-09-21 - Cross-platform, quantum error mitigation toolkit and compiler from [Unitary Foundation](https://unitary.foundation/).
...
* [MQT Predictor](https://github.com/cda-tum/mqt-predictor) ⭐ 87 | 🐛 29 | 🌐 Python | 📅 2026-09-21 - RL-based compiler optimization. ML-based device selection. Available via the [`mqt.predictor`](https://pypi.org/p/mqt.predictor) Python package.
...
* [MQT IonShuttler](https://github.com/cda-tum/mqt-ion-shuttler) ⭐ 37 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - Exact and heuristic scheduling to manage ion movement within trapped-ion hardware.
...
* [TKET2](https://github.com/CQCL/tket2) ⭐ 60 | 🐛 189 | 🌐 Rust | 📅 2026-09-21 - Rewrite based toolkit for optimization of quantum programs (version 2 of the [TKET](https://github.com/CQCL/tket) ⭐ 316 | 🐛 92 | 🌐 C++ | 📅 2026-09-21 quantum compiler).
...
* [Quil](https://arxiv.org/abs/1608.03355) - Open hybrid quantum/classical instruction set currently used by Rigetti. [Parser](https://github.com/rigetticomputing/pyquil/tree/master/pyquil/_parser) ⭐ 1,497 | 🐛 242 | 🌐 Python | 📅 2026-09-22
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 366 | 🐛 106 | 🌐 Python | 📅 2026-09-21 - Qibo provides a platform agnostic quantum hardware control module with drivers for multiple instruments.
...
* [PyMatching](https://github.com/oscarhiggott/PyMatching) ⭐ 361 | 🐛 27 | 🌐 C++ | 📅 2026-05-22 - Python package for decoding quantum error correcting codes with minimum-weight perfect matching.
* [MQT QECC](https://github.com/cda-tum/mqt-qecc) ⭐ 238 | 🐛 13 | 🌐 Python | 📅 2026-09-21 - Synthesis of fault-tolerant circuits. Decoders. Automatic Application of error correcting codes. Available via the [`mqt.qecc`](https://pypi.org/p/mqt.qecc) Python package.
...
* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,068 | 🐛 108 | 🌐 C | 📅 2026-09-21 - C library for quantum-resistant cryptographic algorithms.
...
* [QCoDeS](https://github.com/QCoDeS/Qcodes) ⭐ 459 | 🐛 263 | 🌐 Python | 📅 2026-09-21 - Python-based data acquisition framework for quantum experiments.
...
* [PyRPL](https://github.com/lneuhaus/pyrpl) ⭐ 210 | 🐛 154 | 🌐 HTML | 📅 2026-09-21 - Turn your RedPitaya into a powerful DSP device, suitable as a digital lockbox and measurement device in quantum optics.
...
* [MQT Qudits](https://github.com/cda-tum/mqt-qudits) ⭐ 39 | 🐛 4 | 🌐 Python | 📅 2026-09-21 - A framework for research and education for mixed-dimensional qudit quantum computing available via the \[`mqt.qudits`] Python package.
...
* [Quantum Nematode](https://github.com/SyntheticBrains/nematode) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - C. elegans navigation simulation using quantum variational circuits.
...
* [MQT Problem Solver](https://github.com/cda-tum/mqt-problemsolver) ⭐ 55 | 🐛 5 | 🌐 Python | 📅 2026-09-21 - Automated Framework for Realizing Quantum Computing Solutions.
...
* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,821 | 🐛 1,037 | 🌐 Python | 📅 2026-09-21.
...
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,821 | 🐛 1,037 | 🌐 Python | 📅 2026-09-21.
