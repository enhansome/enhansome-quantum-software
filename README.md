...
For a curated list of learning resources please check out [desireevl's repo](https://github.com/desireevl/awesome-quantum-computing) ⭐ 3,253 | 🐛 27 | 📅 2024-07-24.
...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,112 | 🐛 503 | 🌐 C++ | 📅 2026-08-16 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,049 | 🐛 119 | 🌐 Python | 📅 2026-08-14 - Framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
...
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 288 | 🐛 182 | 🌐 Python | 📅 2026-08-16).
...
* [QuEST](https://github.com/aniabrown/QuEST) ⭐ 484 | 🐛 53 | 🌐 C++ | 📅 2026-07-25 -  Quantum Exact Simulation Toolkit is a high performance multicore simulator of universal quantum circuits.
...
* [MQT DDSIM](https://github.com/cda-tum/mqt-ddsim) ⭐ 161 | 🐛 10 | 🌐 C++ | 📅 2026-08-16 - Quantum circuit simulator using decision diagrams as a datastructure. Python interface and Qiskit backend via the [`mqt.ddsim`](https://pypi.org/p/mqt.ddsim) Python package.
...
* [Q](https://github.com/itsubaki/q) ⭐ 281 | 🐛 0 | 🌐 Go | 📅 2026-08-16 - Quantum Computation Simulator written purely in GoLang.
...
* [PauliStrings.jl](https://github.com/nicolasloizeau/PauliStrings.jl) ⭐ 70 | 🐛 18 | 🌐 Julia | 📅 2026-08-15 - Many-body simulations in the Pauli strings representation.
...
* [Stim](https://github.com/quantumlib/Stim) ⭐ 805 | 🐛 87 | 🌐 C++ | 📅 2026-08-04 - Fast stabilizer circuit simulator.
* [qsim](https://github.com/quantumlib/qsim) ⭐ 689 | 🐛 49 | 🌐 C++ | 📅 2026-08-15 - Open-source, GPU-enabled C++ and Python library for fast state-vector simulation of quantum circuits.
* [quimb](https://github.com/jcmgray/quimb) ⭐ 659 | 🐛 69 | 🌐 Python | 📅 2026-08-15 - Easy but fast python library for quantum information and many-body calculations, including with tensor networks.
...
* [Tsim](https://github.com/QuEraComputing/tsim) ⭐ 121 | 🐛 9 | 🌐 Python | 📅 2026-08-12 - GPU-accelerated universal quantum circuit sampler via ZX-calculus stabilizer-rank decomposition ([Stim](https://github.com/quantumlib/Stim) ⭐ 805 | 🐛 87 | 🌐 C++ | 📅 2026-08-04-like API, with non-Clifford support).
...
* [ReCirq](https://github.com/quantumlib/ReCirq) ⭐ 309 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modules for running quantum computing applications and experiments through [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,049 | 🐛 119 | 🌐 Python | 📅 2026-08-14.
...
* [Catalyst](https://github.com/PennyLaneAI/catalyst) ⭐ 232 | 🐛 316 | 🌐 Python | 📅 2026-08-15 - AOT/JIT compiler for hybrid quantum computing beyond NISQ. Written in MLIR. Python frontend via [PennyLane](https://pennylane.ai).
...
* [MQT QMAP](https://github.com/cda-tum/mqt-qmap) ⭐ 141 | 🐛 23 | 🌐 C++ | 📅 2026-08-16 - Quantum circuit mapping. Clifford synthesis. Compilation for neutral atom architectures. Compatible with Qiskit through the [`mqt.qmap`](https://pypi.org/p/mqt.qmap) Python package.
...
* [MQT SyReC](https://github.com/cda-tum/mqt-syrec) ⭐ 38 | 🐛 19 | 🌐 C++ | 📅 2026-08-16 - HDL-based synthesis of reversible circuits for optimized circuit designs.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,711 | 🐛 1,141 | 🌐 Python | 📅 2026-08-16 - Python library for quantum circuit rewriting and optimization (supported by IBM).
* [PyZX](https://github.com/Quantomatic/pyzx) ⭐ 539 | 🐛 25 | 🌐 OpenQASM | 📅 2026-08-16 - Python library for quantum circuit rewriting and optimisation using the ZX-calculus.
...
* [MQT Predictor](https://github.com/cda-tum/mqt-predictor) ⭐ 87 | 🐛 27 | 🌐 Python | 📅 2026-08-16 - RL-based compiler optimization. ML-based device selection. Available via the [`mqt.predictor`](https://pypi.org/p/mqt.predictor) Python package.
...
* [MQT IonShuttler](https://github.com/cda-tum/mqt-ion-shuttler) ⭐ 36 | 🐛 2 | 🌐 Python | 📅 2026-08-16 - Exact and heuristic scheduling to manage ion movement within trapped-ion hardware.
...
* [Tesseract Decoder](https://github.com/quantumlib/tesseract-decoder) ⭐ 112 | 🐛 30 | 🌐 C++ | 📅 2026-08-16 - Most Likely Error decoder designed for Low Density Parity Check (LDPC) quantum error-correcting codes.
...
* [MQT QECC](https://github.com/cda-tum/mqt-qecc) ⭐ 231 | 🐛 15 | 🌐 Python | 📅 2026-08-16 - Synthesis of fault-tolerant circuits. Decoders. Automatic Application of error correcting codes. Available via the [`mqt.qecc`](https://pypi.org/p/mqt.qecc) Python package.
...
* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,036 | 🐛 113 | 🌐 C | 📅 2026-08-16 - C library for quantum-resistant cryptographic algorithms.
...
* [MQT Qudits](https://github.com/cda-tum/mqt-qudits) ⭐ 39 | 🐛 4 | 🌐 Python | 📅 2026-08-16 - A framework for research and education for mixed-dimensional qudit quantum computing available via the \[`mqt.qudits`] Python package.
...
* [MQT QCEC](https://github.com/cda-tum/mqt-qcec) ⭐ 117 | 🐛 13 | 🌐 C++ | 📅 2026-08-16 - Equivalence checking of quantum circuits. Verifying compilation flows. Available via the [`mqt.qcec`](https://pypi.org/p/mqt.qcec) package and fully compatible with Qiskit.
* [MQT QuSAT](https://github.com/cda-tum/mqt-qusat) ⭐ 28 | 🐛 2 | 🌐 C++ | 📅 2026-08-16 - Encoding and equivalence checking of Clifford circuits using satisfiablity testing (SAT).
...
* [MQT Debugger](https://github.com/cda-tum/mqt-debugger) ⭐ 21 | 🐛 7 | 🌐 C++ | 📅 2026-08-16 - Debugging quantum circuits with IDE integration based on DAP server.
...
* [toqito](https://github.com/vprusso/toqito) ⭐ 290 | 🐛 2 | 🌐 Python | 📅 2026-08-16 - Framework to study problems pertaining to entanglement theory, nonlocal games, and other aspects of quantum information.
* [MQT Bench](https://github.com/cda-tum/mqt-bench) ⭐ 126 | 🐛 19 | 🌐 Python | 📅 2026-08-16 - Quantum circuit benchmark suite providing benchmark algorithms for different compilation levels. Web application hosted at <https://www.cda.cit.tum.de/mqtbench/>. Also available via the [`mqt.bench`](https://pypi.org/p/mqt.bench) Python package.
* [ZXLive](https://github.com/Quantomatic/zxlive) ⭐ 101 | 🐛 55 | 🌐 Python | 📅 2026-08-16 - GUI editor for ZX diagrams.
...
* [MQT Problem Solver](https://github.com/cda-tum/mqt-problemsolver) ⭐ 54 | 🐛 5 | 🌐 Python | 📅 2026-08-16 - Automated Framework for Realizing Quantum Computing Solutions.
...
* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,711 | 🐛 1,141 | 🌐 Python | 📅 2026-08-16.
...
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,711 | 🐛 1,141 | 🌐 Python | 📅 2026-08-16.
