...
* [CUDA-Q](https://github.com/NVIDIA/cuda-quantum) ⭐ 1,124 | 🐛 551 | 🌐 C++ | 📅 2026-09-05 - Platform for accelerated quantum-classical applications on GPUs, CPUs and QPUs.
...
* [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,057 | 🐛 105 | 🌐 Python | 📅 2026-09-04 - Framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
...
* [Braket](https://github.com/amazon-braket/amazon-braket-sdk-python) ⭐ 374 | 🐛 31 | 🌐 Python | 📅 2026-09-03 - [Amazon's](https://aws.amazon.com/braket/) fully managed quantum computing service for building quantum algorithms.
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 363 | 🐛 106 | 🌐 Python | 📅 2026-09-04 - An open-source framework for quantum simulation, self-hosted quantum hardware control and calibration.
...
* [Qrisp](https://qrisp.eu/) - A high-level programming language and framework for creating and compiling quantum algorithms ([GitHub](https://github.com/eclipse-qrisp/Qrisp) ⭐ 294 | 🐛 208 | 🌐 Python | 📅 2026-09-04).
* [Perceval](https://github.com/Quandela/Perceval) ⭐ 207 | 🐛 6 | 🌐 Python | 📅 2026-09-02 - [Quandela](https://www.quandela.com)'s software library for programming realistic photonic quantum computers.
...
* [MQT DDSIM](https://github.com/cda-tum/mqt-ddsim) ⭐ 162 | 🐛 16 | 🌐 C++ | 📅 2026-09-05 - Quantum circuit simulator using decision diagrams as a datastructure. Python interface and Qiskit backend via the [`mqt.ddsim`](https://pypi.org/p/mqt.ddsim) Python package.
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 363 | 🐛 106 | 🌐 Python | 📅 2026-09-04 - Framework for quantum simulation with hardware acceleration using just-in-time compilation.
...
* [scpn-quantum-control](https://github.com/anulum/scpn-quantum-control) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-04 - Quantum simulation of coupled Kuramoto-XY oscillators on IBM hardware, with Rust-accelerated Hamiltonian construction, synchronisation witnesses, and Lindblad open-system dynamics.
...
* [Pulser](https://github.com/pasqal-io/Pulser) ⭐ 242 | 🐛 43 | 🌐 Python | 📅 2026-09-04 - Python library for pulse-level/analog control of neutral atom devices.
...
* [ReCirq](https://github.com/quantumlib/ReCirq) ⭐ 309 | 🐛 19 | 🌐 Python | 📅 2026-07-17 - Modules for running quantum computing applications and experiments through [Cirq](https://github.com/quantumlib/Cirq) ⭐ 5,057 | 🐛 105 | 🌐 Python | 📅 2026-09-04.
...
* [Catalyst](https://github.com/PennyLaneAI/catalyst) ⭐ 234 | 🐛 318 | 🌐 Python | 📅 2026-09-04 - AOT/JIT compiler for hybrid quantum computing beyond NISQ. Written in MLIR. Python frontend via [PennyLane](https://pennylane.ai).
...
* [MQT QMAP](https://github.com/cda-tum/mqt-qmap) ⭐ 142 | 🐛 29 | 🌐 C++ | 📅 2026-09-05 - Quantum circuit mapping. Clifford synthesis. Compilation for neutral atom architectures. Compatible with Qiskit through the [`mqt.qmap`](https://pypi.org/p/mqt.qmap) Python package.
...
* [MQT SyReC](https://github.com/cda-tum/mqt-syrec) ⭐ 38 | 🐛 26 | 🌐 C++ | 📅 2026-09-05 - HDL-based synthesis of reversible circuits for optimized circuit designs.
...
* [Qiskit Terra](https://github.com/Qiskit/qiskit-terra) ⭐ 7,775 | 🐛 1,198 | 🌐 Python | 📅 2026-09-05 - Python library for quantum circuit rewriting and optimization (supported by IBM).
...
* [Mitiq](https://github.com/unitaryfoundation/mitiq) ⭐ 445 | 🐛 100 | 🌐 Python | 📅 2026-09-04 - Cross-platform, quantum error mitigation toolkit and compiler from [Unitary Foundation](https://unitary.foundation/).
...
* [MQT Predictor](https://github.com/cda-tum/mqt-predictor) ⭐ 87 | 🐛 32 | 🌐 Python | 📅 2026-09-05 - RL-based compiler optimization. ML-based device selection. Available via the [`mqt.predictor`](https://pypi.org/p/mqt.predictor) Python package.
...
* [MQT IonShuttler](https://github.com/cda-tum/mqt-ion-shuttler) ⭐ 36 | 🐛 6 | 🌐 Python | 📅 2026-09-05 - Exact and heuristic scheduling to manage ion movement within trapped-ion hardware.
...
* [TKET2](https://github.com/CQCL/tket2) ⭐ 60 | 🐛 174 | 🌐 Rust | 📅 2026-09-04 - Rewrite based toolkit for optimization of quantum programs (version 2 of the [TKET](https://github.com/CQCL/tket) ⭐ 315 | 🐛 91 | 🌐 C++ | 📅 2026-09-03 quantum compiler).
...
* [Qibo](https://github.com/qiboteam/qibo) ⭐ 363 | 🐛 106 | 🌐 Python | 📅 2026-09-04 - Qibo provides a platform agnostic quantum hardware control module with drivers for multiple instruments.
...
* [CodingTheory](https://github.com/esabo/CodingTheory) ⭐ 41 | 🐛 12 | 🌐 Julia | 📅 2026-09-03 - Julia package for constructing and analyzing classical and quantum error-correcting codes.
...
* [MQT QECC](https://github.com/cda-tum/mqt-qecc) ⭐ 237 | 🐛 14 | 🌐 Python | 📅 2026-09-05 - Synthesis of fault-tolerant circuits. Decoders. Automatic Application of error correcting codes. Available via the [`mqt.qecc`](https://pypi.org/p/mqt.qecc) Python package.
...
* [liboqs](https://github.com/open-quantum-safe/liboqs) ⭐ 3,054 | 🐛 115 | 🌐 C | 📅 2026-09-03 - C library for quantum-resistant cryptographic algorithms.
...
* [MQT Qudits](https://github.com/cda-tum/mqt-qudits) ⭐ 39 | 🐛 9 | 🌐 Python | 📅 2026-09-05 - A framework for research and education for mixed-dimensional qudit quantum computing available via the \[`mqt.qudits`] Python package.
...
* [Quantum Nematode](https://github.com/SyntheticBrains/nematode) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2026-09-04 - C. elegans navigation simulation using quantum variational circuits.
...
* [MQT QCEC](https://github.com/cda-tum/mqt-qcec) ⭐ 117 | 🐛 20 | 🌐 C++ | 📅 2026-09-05 - Equivalence checking of quantum circuits. Verifying compilation flows. Available via the [`mqt.qcec`](https://pypi.org/p/mqt.qcec) package and fully compatible with Qiskit.
* [MQT QuSAT](https://github.com/cda-tum/mqt-qusat) ⭐ 28 | 🐛 8 | 🌐 C++ | 📅 2026-09-05 - Encoding and equivalence checking of Clifford circuits using satisfiablity testing (SAT).
* [MQT DDVis](https://github.com/cda-tum/mqt-ddvis) ⭐ 27 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-05 - Installation-free web-tool that visualizes quantum decision diagrams for classical simulation and verification. Hosted at <https://www.cda.cit.tum.de/app/ddvis/>.
* [MQT Debugger](https://github.com/cda-tum/mqt-debugger) ⭐ 21 | 🐛 15 | 🌐 C++ | 📅 2026-09-05 - Debugging quantum circuits with IDE integration based on DAP server.
...
* [toqito](https://github.com/vprusso/toqito) ⭐ 290 | 🐛 21 | 🌐 Python | 📅 2026-09-04 - Framework to study problems pertaining to entanglement theory, nonlocal games, and other aspects of quantum information.
* [MQT Bench](https://github.com/cda-tum/mqt-bench) ⭐ 127 | 🐛 21 | 🌐 Python | 📅 2026-09-05 - Quantum circuit benchmark suite providing benchmark algorithms for different compilation levels. Web application hosted at <https://www.cda.cit.tum.de/mqtbench/>. Also available via the [`mqt.bench`](https://pypi.org/p/mqt.bench) Python package.
...
* [MQT Problem Solver](https://github.com/cda-tum/mqt-problemsolver) ⭐ 54 | 🐛 5 | 🌐 Python | 📅 2026-09-05 - Automated Framework for Realizing Quantum Computing Solutions.
...
* [Qiskit Tutorial](https://github.com/QISKit/qiskit-tutorial) ⚠️ Archived - Jupyter notebook filled with tutorials for [Qiskit](https://github.com/QISKit/qiskit) ⭐ 7,775 | 🐛 1,198 | 🌐 Python | 📅 2026-09-05.
...
* [Qiskit Aqua](https://github.com/Qiskit/qiskit-aqua) ⚠️ Archived - Library of various quantum algorithm implemented with [Qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,775 | 🐛 1,198 | 🌐 Python | 📅 2026-09-05.
